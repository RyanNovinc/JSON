...
exports.CURATED_MEALS = void 0;
exports.CURATED_MEALS = {
    butter_chicken: {
        slug: 'butter_chicken',
        ...
        meal_prep: {
            ...
            storage: 'Keeps ~4 days in the fridge or freezes up to 3 months; reheat gently.',
        },
        plates: [
            {
                id: 'butter_chicken',
    ...
    pulled_pork: {
        ...
        meal_prep: {
            ...
            storage: 'Cooked pork keeps ~4 days in the fridge or freezes up to 3 months.',
        },
        plates: [
            {
                id: 'pulled_pork',
    ...
    massaman: {
        ...
        meal_prep: {
            ...
            storage: 'Keeps ~4 days in the fridge or freezes up to 3 months; reheat gently to keep the beef tender.',
        },
        plates: [
            {
                id: 'massaman',
    ...
    chilli_con_carne: {
        ...
        meal_prep: {
            ...
            storage: 'Keeps ~4-5 days in the fridge or freezes up to 3 months.',
        },
        plates: [
            {
                id: 'chilli_con_carne',
    ...
    maple_muscle_toast: {
        ...
        display_name: 'Maple Muscle Toast',
        cuisine: 'breakfast',
        primary_protein: 'dairy',
        produces_servings: 1,
        eligible_slots: ['breakfast', 'brunch'],
        min_scale: 0.7,
        max_scale: 1.5,
        flex_ingredient_id: 'brioche_loaf',
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Maple Muscle Toast',
                description: 'Thick-cut brioche French toast soaked in a whey-spiked custard, stacked with yoghurt, banana, and maple.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'brioche_loaf', base_amount: 120, unit: 'g', scaling: 'flex', notes: '3 thick slices, approximately 40g each.' },
                    { ingredient_id: 'egg_whole', base_amount: 2, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'full_cream_milk', base_amount: 100, unit: 'ml', scaling: 'scales' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 30, unit: 'g', scaling: 'scales', notes: '1 scoop. Whisk in last so it does not clump.' },
                    { ingredient_id: 'greek_yoghurt_vanilla_full_fat', base_amount: 100, unit: 'g', scaling: 'scales', notes: 'For topping.' },
                    { ingredient_id: 'banana', base_amount: 120, unit: 'g', scaling: 'scales', notes: '1 medium, sliced, for topping.' },
                    { ingredient_id: 'maple_syrup', base_amount: 20, unit: 'ml', scaling: 'scales', notes: 'Approximately 1 tbsp.' },
                    { ingredient_id: 'butter_salted', base_amount: 10, unit: 'g', scaling: 'scales', notes: 'For the pan.' },
                    { ingredient_id: 'cinnamon_ground', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Whisk the eggs, milk, whey, and cinnamon in a wide shallow bowl until completely smooth — add the whey last and whisk well so it does not clump.', substeps: ['Whisk the eggs, milk, whey, and cinnamon in a wide shallow bowl until completely smooth — add the whey last and whisk well so it does not clump.'] },
                    { summary: 'Soak each brioche slice in the custard for 20-30 seconds per side — long enough to soak through, not so long it falls apart.', substeps: ['Soak each brioche slice in the custard for 20-30 seconds per side — long enough to soak through, not so long it falls apart.'] },
                    { summary: 'Melt the butter in a non-stick pan over medium heat. Cook the soaked slices for 2-3 minutes per side until golden and set.', substeps: ['Melt the butter in a non-stick pan over medium heat. Cook the soaked slices for 2-3 minutes per side until golden and set.'] },
                    { summary: 'Stack on a plate, dollop over the Greek yoghurt, fan the sliced banana on top, and drizzle with maple syrup.', substeps: ['Stack on a plate, dollop over the Greek yoghurt, fan the sliced banana on top, and drizzle with maple syrup.'] },
                ],
            },
        ],
    },
    muscle_oats: {
        slug: 'muscle_oats',
        display_name: 'Muscle Oats',
        cuisine: 'breakfast',
        primary_protein: 'dairy',
        produces_servings: 1,
        eligible_slots: ['breakfast', 'brunch', 'post_workout'],
        min_scale: 0.7,
        max_scale: 1.5,
        flex_ingredient_id: 'rolled_oats_raw',
        contains_allergens: ['Dairy', 'Nuts'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Muscle Oats',
                description: 'Creamy oats cooked in milk with whey, banana, and peanut butter — the classic bulking porridge.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                equipment_required: ['stovetop'],
                time_active_minutes: 5,
                time_total_minutes: 8,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'rolled_oats_raw', base_amount: 80, unit: 'g', scaling: 'flex', notes: 'Approximately 3/4 cup.' },
                    { ingredient_id: 'full_cream_milk', base_amount: 250, unit: 'ml', scaling: 'scales' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 30, unit: 'g', scaling: 'scales', notes: '1 scoop. Stir in off the heat so it stays smooth.' },
                    { ingredient_id: 'banana', base_amount: 120, unit: 'g', scaling: 'scales', notes: '1 medium, sliced, for topping.' },
                    { ingredient_id: 'peanut_butter_natural', base_amount: 32, unit: 'g', scaling: 'scales', notes: 'Approximately 2 tbsp, for topping.' },
                    { ingredient_id: 'honey', base_amount: 21, unit: 'g', scaling: 'scales', notes: 'Approximately 1 tbsp.' },
                    { ingredient_id: 'cinnamon_ground', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Combine the oats and milk in a small saucepan over medium heat. Stir often and simmer for 4-5 minutes until thick and creamy.', substeps: ['Combine the oats and milk in a small saucepan over medium heat. Stir often and simmer for 4-5 minutes until thick and creamy.'] },
                    { summary: 'Take it off the heat and let it sit for a minute, then stir the whey through — off the heat keeps it smooth rather than grainy.', substeps: ['Take it off the heat and let it sit for a minute, then stir the whey through — off the heat keeps it smooth rather than grainy.'] },
                    { summary: 'Stir in the honey and cinnamon, then tip into a bowl.', substeps: ['Stir in the honey and cinnamon, then tip into a bowl.'] },
                    { summary: 'Top with the sliced banana and peanut butter (warm the peanut butter 15 seconds to drizzle, if you like).', substeps: ['Top with the sliced banana and peanut butter (warm the peanut butter 15 seconds to drizzle, if you like).'] },
                ],
            },
            {
                id: 'microwave',
                ...
                instructions: [
                    { summary: 'Combine the oats and milk in a large microwave-safe bowl — bigger than you think, it bubbles up.', substeps: ['Combine the oats and milk in a large microwave-safe bowl — bigger than you think, it bubbles up.'] },
                    { summary: 'Microwave on high for 2-2.5 minutes, stopping to stir halfway, until thick.', substeps: ['Microwave on high for 2-2.5 minutes, stopping to stir halfway, until thick.'] },
                    { summary: 'Let it sit for a minute, then stir the whey, honey, and cinnamon through.', substeps: ['Let it sit for a minute, then stir the whey, honey, and cinnamon through.'] },
                    { summary: 'Top with the sliced banana and peanut butter.', substeps: ['Top with the sliced banana and peanut butter.'] },
                ],
            },
        ],
    },
    scramble_stack: {
        ...
        min_scale: 0.7,
        max_scale: 1.5,
        flex_ingredient_id: 'sourdough_crusty',
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Scramble Stack',
                description: 'Soft-scrambled cheesy eggs piled on buttered sourdough with smashed avocado — the savoury staple.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                time_total_minutes: 12,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'egg_whole', base_amount: 4, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'cheese_tasty_grated', base_amount: 40, unit: 'g', scaling: 'scales', notes: 'Stirred through the eggs at the end.' },
                    { ingredient_id: 'sourdough_crusty', base_amount: 100, unit: 'g', scaling: 'flex', notes: '2 thick slices.' },
                    { ingredient_id: 'avocado', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Flesh only, smashed onto the toast.' },
                    { ingredient_id: 'butter_salted', base_amount: 12, unit: 'g', scaling: 'scales', notes: 'For the eggs and the toast.' },
                    { ingredient_id: 'salt', base_amount: 0.25, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'black_pepper_ground', base_amount: 0.25, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Crack the eggs into a bowl, season with the salt and pepper, and whisk until just combined.', substeps: ['Crack the eggs into a bowl, season with the salt and pepper, and whisk until just combined.'] },
                    { summary: 'Toast the sourdough, spread with half the butter, smash the avocado on top, and season.', substeps: ['Toast the sourdough, spread with half the butter, smash the avocado on top, and season.'] },
                    { summary: 'Melt the rest of the butter in a non-stick pan over medium-low heat. Add the eggs and stir gently, pulling them in from the edges until softly set — about 2-3 minutes. Stir the cheese through in the last 30 seconds.', substeps: ['Melt the rest of the butter in a non-stick pan over medium-low heat. Add the eggs and stir gently, pulling them in from the edges until softly set — about 2-3 minutes. Stir the cheese through in the last 30 seconds.'] },
                    { summary: 'Pile the cheesy scramble onto the avocado toast, crack over more pepper, and eat immediately.', substeps: ['Pile the cheesy scramble onto the avocado toast, crack over more pepper, and eat immediately.'] },
                ],
            },
        ],
    },
    overnight_oats: {
        slug: 'overnight_oats',
        display_name: 'Protein Overnight Oats',
        cuisine: 'breakfast',
        primary_protein: 'dairy',
        produces_servings: 1,
        eligible_slots: ['breakfast', 'brunch', 'post_workout'],
        ...
        meal_prep: {
            ...
            storage: 'Keeps 3-4 days sealed in the fridge; loosen with a splash of milk before eating.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Protein Overnight Oats',
                description: 'Creamy no-cook oats soaked overnight with Greek yoghurt, whey, and chia, topped with banana.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                    { ingredient_id: 'banana', base_amount: 120, unit: 'g', scaling: 'scales', notes: '1 medium, sliced over the top.' },
                ],
                additional_instructions: [
            ...
            {
                id: 'loaded',
                display_name: 'Loaded Protein Overnight Oats',
                description: 'The same jar, bulked up with banana, a peanut butter drizzle, and a scatter of granola.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                    { ingredient_id: 'banana', base_amount: 120, unit: 'g', scaling: 'scales', notes: '1 medium, sliced over the top.' },
                    { ingredient_id: 'peanut_butter_natural', base_amount: 32, unit: 'g', scaling: 'scales', notes: 'Approximately 2 tbsp, drizzled.' },
                    { ingredient_id: 'granola', base_amount: 40, unit: 'g', scaling: 'scales', notes: 'Approximately 1/3 cup, scattered for crunch.' },
                ],
                additional_instructions: [
        ...
        methods: [
            {
                id: 'no_cook',
                display_name: 'No-Cook (Overnight)',
                equipment_required: ['no_cook'],
                time_active_minutes: 5,
                time_total_minutes: 245,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'rolled_oats_raw', base_amount: 50, unit: 'g', scaling: 'flex', notes: 'Approximately 1/2 cup.' },
                    { ingredient_id: 'chia_seeds', base_amount: 10, unit: 'g', scaling: 'scales', notes: 'Thickens the oats as they soak.' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 30, unit: 'g', scaling: 'scales', notes: '1 scoop. Pre-mix with a splash of the milk to avoid clumps.' },
                    { ingredient_id: 'full_cream_milk', base_amount: 200, unit: 'ml', scaling: 'scales' },
                    { ingredient_id: 'greek_yoghurt_vanilla_full_fat', base_amount: 120, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'honey', base_amount: 21, unit: 'g', scaling: 'scales', notes: 'Approximately 1 tbsp.' },
                ],
                instructions: [
                    { summary: 'Add the oats, chia, whey, milk, Greek yoghurt, and honey to a jar or container and stir well until no dry pockets or whey clumps remain.', substeps: ['Add the oats, chia, whey, milk, Greek yoghurt, and honey to a jar or container and stir well until no dry pockets or whey clumps remain.'] },
                    { summary: 'Seal and refrigerate for at least 4 hours, ideally overnight.', substeps: ['Seal and refrigerate for at least 4 hours, ideally overnight.'] },
                    { summary: 'In the morning, give it a stir and loosen with a splash of milk if it has thickened too much.', substeps: ['In the morning, give it a stir and loosen with a splash of milk if it has thickened too much.'] },
                ],
            },
        ],
    },
    greek_yoghurt_bowl: {
        slug: 'greek_yoghurt_bowl',
        display_name: 'Greek Yoghurt Power Bowl',
        cuisine: 'breakfast',
        primary_protein: 'dairy',
        produces_servings: 1,
        eligible_slots: ['breakfast', 'brunch', 'post_workout'],
        min_scale: 0.7,
        max_scale: 1.5,
        flex_ingredient_id: 'greek_yoghurt_vanilla_full_fat',
        contains_allergens: ['Dairy', 'Nuts'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Greek Yoghurt Power Bowl',
                description: 'A thick protein-yoghurt base topped with berries, chia, and granola — no-cook, 5 minutes.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                    { ingredient_id: 'mixed_berries', base_amount: 100, unit: 'g', scaling: 'scales', notes: 'Fresh or frozen.' },
                    { ingredient_id: 'chia_seeds', base_amount: 10, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'granola', base_amount: 40, unit: 'g', scaling: 'scales', notes: 'Approximately 1/3 cup, for crunch.' },
                ],
                additional_instructions: [
            ...
            {
                id: 'loaded',
                display_name: 'Loaded Greek Yoghurt Power Bowl',
                description: 'The same protein-yoghurt base, bulked up with banana, peanut butter, and extra granola.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                    { ingredient_id: 'mixed_berries', base_amount: 100, unit: 'g', scaling: 'scales', notes: 'Fresh or frozen.' },
                    { ingredient_id: 'banana', base_amount: 120, unit: 'g', scaling: 'scales', notes: '1 medium, sliced.' },
                    { ingredient_id: 'chia_seeds', base_amount: 10, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'granola', base_amount: 50, unit: 'g', scaling: 'scales', notes: 'Approximately 1/2 cup.' },
                    { ingredient_id: 'peanut_butter_natural', base_amount: 32, unit: 'g', scaling: 'scales', notes: 'Approximately 2 tbsp, drizzled.' },
                ],
                additional_instructions: [
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'greek_yoghurt_vanilla_full_fat', base_amount: 280, unit: 'g', scaling: 'flex' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 30, unit: 'g', scaling: 'scales', notes: '1 scoop, stirred into the yoghurt for a thick protein base.' },
                    { ingredient_id: 'honey', base_amount: 21, unit: 'g', scaling: 'scales', notes: 'Approximately 1 tbsp.' },
                ],
                instructions: [
                    { summary: 'Spoon the Greek yoghurt into a bowl, add the whey and honey, and stir until smooth and creamy — loosen with a splash of milk if it gets too thick.', substeps: ['Spoon the Greek yoghurt into a bowl, add the whey and honey, and stir until smooth and creamy — loosen with a splash of milk if it gets too thick.'] },
                ],
            },
        ],
    },
    cottage_cheese_bowl: {
        slug: 'cottage_cheese_bowl',
        display_name: 'Cottage Cheese Power Bowl',
        cuisine: 'breakfast',
        primary_protein: 'dairy',
        produces_servings: 1,
        eligible_slots: ['breakfast', 'brunch', 'morning_snack', 'lunch', 'afternoon_snack'],
        min_scale: 0.7,
        max_scale: 1.4,
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Cottage Cheese Power Bowl',
                description: 'High-protein savoury bowl with cottage cheese, fresh vegetables, and everything bagel seasoning',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'no_cook',
                display_name: 'No-Cook Assembly',
                equipment_required: ['no_cook'],
                time_active_minutes: 3,
                time_total_minutes: 3,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'cottage_cheese', base_amount: 250, unit: 'g', scaling: 'flex', notes: 'Full-fat cottage cheese, approximately 1 cup.' },
                    { ingredient_id: 'cherry_tomatoes', base_amount: 100, unit: 'g', scaling: 'scales', notes: 'Halved, approximately 6-8 cherry tomatoes.' },
                    { ingredient_id: 'cucumber', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Diced, approximately ½ medium cucumber.' },
                    { ingredient_id: 'olive_oil', base_amount: 14, unit: 'g', scaling: 'scales', notes: 'Extra virgin olive oil, approximately 1 tbsp.' },
                    { ingredient_id: 'everything_bagel_seasoning', base_amount: 1, unit: 'tsp', scaling: 'fixed', notes: 'Approximately 1 tsp for topping.' },
                    { ingredient_id: 'salt', base_amount: 0.25, unit: 'tsp', scaling: 'fixed', notes: 'Pinch to taste.' },
                    { ingredient_id: 'black_pepper_ground', base_amount: 0.25, unit: 'tsp', scaling: 'fixed', notes: 'Freshly ground, to taste.' },
                ],
                instructions: [
                    { summary: 'Prep the vegetables by halving the cherry tomatoes and dicing the cucumber into small cubes.', substeps: ['Wash and halve the cherry tomatoes.', 'Wash, peel if desired, and dice the cucumber into small cubes.'] },
                    { summary: 'Assemble the bowl by spooning cottage cheese into a serving bowl and topping with vegetables, olive oil, and seasoning.', substeps: ['Spoon the cottage cheese into a serving bowl.', 'Top with halved cherry tomatoes and diced cucumber.', 'Drizzle with olive oil.', 'Season with salt, pepper, and everything bagel seasoning.', 'Mix gently if desired, or serve with distinct layers for visual appeal.'] },
                ],
            },
        ],
    },
    pb_banana_toast: {
        slug: 'pb_banana_toast',
        display_name: 'PB Banana Toast',
        cuisine: 'breakfast',
        primary_protein: 'dairy',
        produces_servings: 1,
        eligible_slots: ['breakfast', 'brunch', 'post_workout'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'PB Banana Toast',
                description: 'Toasted sourdough with peanut butter and a whey-spiked mashed-banana spread, finished with honey and chia.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'sourdough_crusty', base_amount: 120, unit: 'g', scaling: 'flex', notes: '2-3 slices.' },
                    { ingredient_id: 'peanut_butter_natural', base_amount: 40, unit: 'g', scaling: 'scales', notes: 'Approximately 2.5 tbsp.' },
                    { ingredient_id: 'banana', base_amount: 120, unit: 'g', scaling: 'scales', notes: '1 medium.' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 25, unit: 'g', scaling: 'scales', notes: 'Mashed into the banana so it spreads smooth.' },
                    { ingredient_id: 'honey', base_amount: 14, unit: 'g', scaling: 'scales', notes: 'Approximately 1/2 tbsp.' },
                    { ingredient_id: 'chia_seeds', base_amount: 8, unit: 'g', scaling: 'scales' },
                ],
                instructions: [
                    { summary: 'Toast the sourdough.', substeps: ['Toast the sourdough.'] },
                    { summary: 'Mash the banana in a bowl with a fork, sprinkle in the whey, and mash again until smooth and combined.', substeps: ['Mash the banana in a bowl with a fork, sprinkle in the whey, and mash again until smooth and combined.'] },
                    { summary: 'Spread the peanut butter over the toast, then spread the banana-whey mash on top.', substeps: ['Spread the peanut butter over the toast, then spread the banana-whey mash on top.'] },
                    { summary: 'Drizzle with honey and sprinkle over the chia seeds.', substeps: ['Drizzle with honey and sprinkle over the chia seeds.'] },
                ],
            },
        ],
    },
    protein_pancakes: {
        slug: 'protein_pancakes',
        ...
        meal_prep: {
            ...
            storage: 'Pancakes keep ~3 days in the fridge or freeze up to 1 month; reheat in a toaster, pan or microwave.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Protein Pancakes',
                description: 'Fluffy blender pancakes of oats, whey, Greek yoghurt, and egg, topped with berries and maple.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                    { ingredient_id: 'mixed_berries', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Fresh or frozen, scattered on top.' },
                    { ingredient_id: 'maple_syrup', base_amount: 20, unit: 'ml', scaling: 'scales', notes: 'Approximately 1 tbsp.' },
                ],
                additional_instructions: [
            ...
            {
                id: 'loaded',
                display_name: 'Loaded Protein Pancakes',
                description: 'The same stack, bulked up with sliced banana, a peanut butter drizzle, and maple.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                    { ingredient_id: 'banana', base_amount: 120, unit: 'g', scaling: 'scales', notes: '1 medium, sliced.' },
                    { ingredient_id: 'peanut_butter_natural', base_amount: 32, unit: 'g', scaling: 'scales', notes: 'Approximately 2 tbsp, drizzled.' },
        ...
        methods: [
            {
                id: 'stovetop',
                display_name: 'Stovetop',
                equipment_required: ['stovetop', 'blender'],
                time_active_minutes: 15,
                time_total_minutes: 18,
                skill_min: 2,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'rolled_oats_raw', base_amount: 60, unit: 'g', scaling: 'flex', notes: 'Blended to a flour.' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 30, unit: 'g', scaling: 'scales', notes: '1 scoop.' },
                    { ingredient_id: 'egg_whole', base_amount: 2, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'greek_yoghurt_vanilla_full_fat', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Keeps the pancakes moist and fluffy.' },
                    { ingredient_id: 'full_cream_milk', base_amount: 60, unit: 'ml', scaling: 'scales', notes: 'To thin the batter.' },
                    { ingredient_id: 'baking_powder', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'butter_salted', base_amount: 8, unit: 'g', scaling: 'scales', notes: 'For the pan.' },
                ],
                instructions: [
                    { summary: 'Blend the oats, whey, eggs, Greek yoghurt, milk, and baking powder into a smooth batter and let it rest for 5 minutes.', substeps: ['Blend the oats, whey, eggs, Greek yoghurt, milk, and baking powder into a smooth batter and let it rest for 5 minutes.'] },
                    { summary: 'Melt the butter in a non-stick pan over medium heat. Pour in about 1/4 cup of batter per pancake and cook for about 2 minutes until bubbles form on the surface.', substeps: ['Melt the butter in a non-stick pan over medium heat. Pour in about 1/4 cup of batter per pancake and cook for about 2 minutes until bubbles form on the surface.'] },
                    { summary: 'Flip and cook another 1-2 minutes until golden and set. Repeat with the remaining batter.', substeps: ['Flip and cook another 1-2 minutes until golden and set. Repeat with the remaining batter.'] },
                ],
            },
        ],
    },
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Steak & Eggs',
                description: 'Garlic-butter seared sirloin with fried eggs and crispy pan potatoes — the highest-protein plate in the set.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'sirloin_steak', base_amount: 200, unit: 'g', scaling: 'flex' },
                    { ingredient_id: 'egg_whole', base_amount: 3, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'potato_waxy', base_amount: 200, unit: 'g', scaling: 'scales', notes: 'Diced small.' },
                    { ingredient_id: 'butter_salted', base_amount: 12, unit: 'g', scaling: 'scales', notes: 'For searing the steak.' },
                    { ingredient_id: 'olive_oil', base_amount: 7, unit: 'g', scaling: 'scales', notes: 'For the potatoes.' },
                    { ingredient_id: 'garlic_clove', base_amount: 2, unit: 'cloves', scaling: 'fixed', notes: 'Crushed, for the steak butter.' },
                ...
                instructions: [
                    { summary: 'Pat the steak dry, season both sides with salt and pepper, and leave it to come up to room temperature.', substeps: ['Pat the steak dry, season both sides with salt and pepper, and leave it to come up to room temperature.'] },
                    { summary: 'Dice the potatoes and pan-fry in the olive oil over medium-high heat for 12-15 minutes until golden and tender, then season and set aside.', substeps: ['Dice the potatoes and pan-fry in the olive oil over medium-high heat for 12-15 minutes until golden and tender, then season and set aside.'] },
                    { summary: 'Sear the steak in the butter with the crushed garlic over high heat, 2-3 minutes per side for medium, then rest it for 5 minutes.', substeps: ['Sear the steak in the butter with the crushed garlic over high heat, 2-3 minutes per side for medium, then rest it for 5 minutes.'] },
                    { summary: 'Fry the eggs in the same pan, slice the rested steak, and plate everything together.', substeps: ['Fry the eggs in the same pan, slice the rested steak, and plate everything together.'] },
                ],
            },
        ],
    },
    shakshuka: {
        ...
        primary_protein: 'eggs',
        produces_servings: 1,
        eligible_slots: ['breakfast', 'brunch', 'lunch', 'dinner'],
        min_scale: 0.7,
        max_scale: 1.5,
        flex_ingredient_id: 'sourdough_crusty',
        contains_allergens: ['Dairy', 'Eggs', 'Gluten/Wheat'],
        ...
        meal_prep: {
            strategy: 'partial',
            prep_note: 'Make the spiced tomato-capsicum sauce ahead; poach the eggs into the reheated sauce and crumble the feta fresh when serving. Carb check: no starch is cooked ahead — the sourdough is toasted/served fresh, and the day-of element (eggs + feta) lives in the method, not a plate, so the split is within the method rather than at the plate boundary.',
            storage: 'The sauce keeps ~4-5 days in the fridge or freezes up to 3 months; poach eggs fresh into it each time.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Shakshuka',
                description: 'Eggs poached in a spiced tomato and capsicum sauce, topped with feta and served with sourdough for scooping.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                ingredients: [
                    { ingredient_id: 'egg_whole', base_amount: 4, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'crushed_tomatoes_canned', base_amount: 250, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'capsicum_red', base_amount: 100, unit: 'g', scaling: 'scales', notes: 'Diced.' },
                    { ingredient_id: 'brown_onion', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Diced.' },
                    { ingredient_id: 'feta', base_amount: 40, unit: 'g', scaling: 'scales', notes: 'Crumbled on top.' },
                    { ingredient_id: 'sourdough_crusty', base_amount: 100, unit: 'g', scaling: 'flex', notes: '2 slices, to serve and scoop.' },
                    { ingredient_id: 'olive_oil', base_amount: 9, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'garlic_clove', base_amount: 2, unit: 'cloves', scaling: 'fixed', notes: 'Crushed.' },
    ...
    freezer_breakfast_burrito: {
        slug: 'freezer_breakfast_burrito',
        display_name: 'Freezer Breakfast Burrito',
        cuisine: 'breakfast',
        primary_protein: 'pork',
        produces_servings: 5,
        eligible_slots: ['breakfast', 'brunch', 'lunch'],
        min_scale: 0.7,
        max_scale: 1.5,
        flex_ingredient_id: 'breakfast_sausage',
        contains_allergens: ['Dairy', 'Eggs', 'Gluten/Wheat'],
        ...
        meal_prep: {
            ...
            storage: 'Up to 3 months frozen; reheat from frozen in the microwave then crisp in a dry pan.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Freezer Breakfast Burrito',
                description: 'A batch of 5 hearty sausage, egg, cheese, and potato burritos to wrap and freeze. Macros are per burrito.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'breakfast_sausage', base_amount: 350, unit: 'g', scaling: 'flex', notes: 'Browned and crumbled.' },
                    { ingredient_id: 'egg_whole', base_amount: 10, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'tortilla_large', base_amount: 5, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'cheese_tasty_grated', base_amount: 150, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'potato_waxy', base_amount: 250, unit: 'g', scaling: 'scales', notes: 'Diced small for hash.' },
                    { ingredient_id: 'brown_onion', base_amount: 120, unit: 'g', scaling: 'scales', notes: 'Diced.' },
                    { ingredient_id: 'capsicum_red', base_amount: 120, unit: 'g', scaling: 'scales', notes: 'Diced.' },
                    { ingredient_id: 'olive_oil', base_amount: 11, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'salt', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'black_pepper_ground', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Dice and fry the potato in the olive oil over medium-high heat for 10-12 minutes until tender, then add the onion and capsicum and cook until soft. Set aside.', substeps: ['Dice and fry the potato in the olive oil over medium-high heat for 10-12 minutes until tender, then add the onion and capsicum and cook until soft. Set aside.'] },
                    { summary: 'Brown the breakfast sausage in the pan, breaking it up, until cooked through.', substeps: ['Brown the breakfast sausage in the pan, breaking it up, until cooked through.'] },
                    { summary: 'Whisk the eggs with salt and pepper and scramble softly.', substeps: ['Whisk the eggs with salt and pepper and scramble softly.'] },
                    { summary: 'Lay out the tortillas, divide the sausage, eggs, potato-veg mix, and cheese between them, and roll up tightly.', substeps: ['Lay out the tortillas, divide the sausage, eggs, potato-veg mix, and cheese between them, and roll up tightly.'] },
                    { summary: 'Eat one now; wrap the rest individually in foil and freeze. Reheat from frozen in the microwave, then crisp in a pan.', substeps: ['Eat one now; wrap the rest individually in foil and freeze. Reheat from frozen in the microwave, then crisp in a pan.'] },
                ],
            },
        ],
    },
    baked_oats: {
        ...
        meal_prep: {
            ...
            storage: 'Keeps ~4 days in the fridge; reheat in the microwave or a low oven.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Baked Oats',
                description: 'A cake-like baked oat pudding with whey in the batter, topped with Greek yoghurt and berries.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                    { ingredient_id: 'greek_yoghurt_vanilla_full_fat', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Dolloped on top.' },
                    { ingredient_id: 'mixed_berries', base_amount: 60, unit: 'g', scaling: 'scales', notes: 'Fresh or frozen.' },
                ],
                additional_instructions: [
            ...
            {
                id: 'loaded',
                display_name: 'Loaded Baked Oats',
                description: 'The same baked oats, bulked up with Greek yoghurt, sliced banana, and a peanut butter drizzle.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                    { ingredient_id: 'greek_yoghurt_vanilla_full_fat', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Dolloped on top.' },
                    { ingredient_id: 'banana', base_amount: 60, unit: 'g', scaling: 'scales', notes: 'Sliced over.' },
                    { ingredient_id: 'peanut_butter_natural', base_amount: 32, unit: 'g', scaling: 'scales', notes: 'Approximately 2 tbsp, drizzled.' },
                ],
                additional_instructions: [
        ...
        methods: [
            {
                ...
                display_name: 'Oven',
                equipment_required: ['oven'],
                time_active_minutes: 8,
                time_total_minutes: 30,
                skill_min: 2,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'rolled_oats_raw', base_amount: 80, unit: 'g', scaling: 'flex' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 30, unit: 'g', scaling: 'scales', notes: '1 scoop.' },
                    { ingredient_id: 'egg_whole', base_amount: 1, unit: 'count', scaling: 'scales', notes: 'Binds the batter.' },
                    { ingredient_id: 'full_cream_milk', base_amount: 120, unit: 'ml', scaling: 'scales' },
                    { ingredient_id: 'banana', base_amount: 60, unit: 'g', scaling: 'scales', notes: 'Mashed into the batter.' },
                    { ingredient_id: 'honey', base_amount: 21, unit: 'g', scaling: 'scales', notes: 'Approximately 1 tbsp.' },
                    { ingredient_id: 'baking_powder', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'cinnamon_ground', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Preheat the oven to 180C (350F) and mash the banana in a bowl.', substeps: ['Preheat the oven to 180C (350F) and mash the banana in a bowl.'] },
                    { summary: 'Add the oats, whey, egg, milk, honey, baking powder, and cinnamon, and mix to a smooth batter.', substeps: ['Add the oats, whey, egg, milk, honey, baking powder, and cinnamon, and mix to a smooth batter.'] },
                    { summary: 'Pour into a greased oven dish or large ramekin and bake for 20-22 minutes until set and golden on top.', substeps: ['Pour into a greased oven dish or large ramekin and bake for 20-22 minutes until set and golden on top.'] },
                ],
            },
        ],
    },
    smoked_salmon_bagel: {
        slug: 'smoked_salmon_bagel',
        display_name: 'Smoked Salmon Bagel',
        cuisine: 'breakfast',
        ...
        min_scale: 0.7,
        max_scale: 1.5,
        flex_ingredient_id: 'smoked_salmon',
        contains_allergens: ['Dairy', 'Eggs', 'Fish', 'Gluten/Wheat'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Smoked Salmon Bagel',
                description: 'A toasted bagel with cream cheese, smoked salmon, avocado, cucumber, red onion, and fried eggs — the gym-coded brunch bagel.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'smoked_salmon', base_amount: 100, unit: 'g', scaling: 'flex' },
                    { ingredient_id: 'bagel', base_amount: 1, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'cream_cheese', base_amount: 40, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'egg_whole', base_amount: 2, unit: 'count', scaling: 'scales', notes: 'Fried, yolks soft.' },
                    { ingredient_id: 'avocado', base_amount: 60, unit: 'g', scaling: 'scales', notes: 'Sliced.' },
                    { ingredient_id: 'cucumber', base_amount: 40, unit: 'g', scaling: 'scales', notes: 'Sliced.' },
                    { ingredient_id: 'brown_onion', base_amount: 20, unit: 'g', scaling: 'scales', notes: 'Red onion, thinly sliced.' },
                    { ingredient_id: 'olive_oil', base_amount: 5, unit: 'g', scaling: 'scales', notes: 'For frying the eggs.' },
                    { ingredient_id: 'salt', base_amount: 0.25, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'black_pepper_ground', base_amount: 0.25, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Slice and toast the bagel, and fry the eggs in the olive oil to your liking — keep the yolks soft.', substeps: ['Slice and toast the bagel, and fry the eggs in the olive oil to your liking — keep the yolks soft.'] },
                    { summary: 'Spread the cream cheese over both toasted bagel halves and season (a squeeze of lemon and dill is great if you have them).', substeps: ['Spread the cream cheese over both toasted bagel halves and season (a squeeze of lemon and dill is great if you have them).'] },
                    { summary: 'Layer the cucumber, smoked salmon, red onion, avocado, and fried eggs on the base.', substeps: ['Layer the cucumber, smoked salmon, red onion, avocado, and fried eggs on the base.'] },
                    { summary: 'Top with the other bagel half, press gently, and slice.', substeps: ['Top with the other bagel half, press gently, and slice.'] },
                ],
            },
        ],
    },
    big_breakfast_plate: {
        slug: 'big_breakfast_plate',
        display_name: 'Big Breakfast Plate',
        cuisine: 'breakfast',
        primary_protein: 'pork',
        produces_servings: 1,
        eligible_slots: ['breakfast', 'brunch'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Big Breakfast Plate',
                description: 'The full cooked fry-up: fried eggs, bacon, sausage, mushrooms, grilled tomato, baked beans, and sourdough toast.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'breakfast_sausage', base_amount: 120, unit: 'g', scaling: 'flex', notes: '2 sausages or equivalent.' },
                    { ingredient_id: 'bacon', base_amount: 60, unit: 'g', scaling: 'scales', notes: '3 rashers.' },
                    { ingredient_id: 'egg_whole', base_amount: 3, unit: 'count', scaling: 'scales', notes: 'Fried.' },
                    { ingredient_id: 'baked_beans', base_amount: 130, unit: 'g', scaling: 'scales', notes: 'About half a small can.' },
                    { ingredient_id: 'mushroom_brown', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Sliced.' },
                    { ingredient_id: 'cherry_tomatoes', base_amount: 100, unit: 'g', scaling: 'scales', notes: 'Halved.' },
                    { ingredient_id: 'sourdough_crusty', base_amount: 100, unit: 'g', scaling: 'scales', notes: '2 slices, toasted.' },
                    { ingredient_id: 'butter_salted', base_amount: 12, unit: 'g', scaling: 'scales', notes: 'For frying and the toast.' },
                    { ingredient_id: 'salt', base_amount: 0.25, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'black_pepper_ground', base_amount: 0.25, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Fry the bacon and sausage in a large pan over medium heat for 6-8 minutes until cooked, then set aside and keep warm.', substeps: ['Fry the bacon and sausage in a large pan over medium heat for 6-8 minutes until cooked, then set aside and keep warm.'] },
                    { summary: 'In the same pan, fry the sliced mushrooms and halved tomatoes for 4-5 minutes until soft and browned.', substeps: ['In the same pan, fry the sliced mushrooms and halved tomatoes for 4-5 minutes until soft and browned.'] },
                    { summary: 'Warm the baked beans and toast the sourdough.', substeps: ['Warm the baked beans and toast the sourdough.'] },
                    { summary: 'Fry the eggs in the pan to your liking, then plate everything together.', substeps: ['Fry the eggs in the pan to your liking, then plate everything together.'] },
                ],
            },
        ],
    },
    egg_muffins: {
        ...
        meal_prep: {
            ...
            storage: 'Muffins keep ~4 days in the fridge or freeze up to 1 month; reheat 30-45s in the microwave.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Egg Muffins',
                description: 'A batch of 12 cottage-cheese-blended egg muffins with sausage and spinach. One serving is 3 muffins, served with avo toast.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                    { ingredient_id: 'sourdough_crusty', base_amount: 100, unit: 'g', scaling: 'scales', notes: '2 slices, toasted, to serve.' },
                    { ingredient_id: 'avocado', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Smashed onto the toast.' },
                ],
                additional_instructions: [
        ...
        methods: [
            {
                id: 'oven',
                display_name: 'Oven (Batch)',
                equipment_required: ['oven', 'blender'],
                time_active_minutes: 15,
                time_total_minutes: 35,
                skill_min: 2,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'egg_whole', base_amount: 8, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'cottage_cheese', base_amount: 250, unit: 'g', scaling: 'flex', notes: 'Blended into the eggs.' },
                    { ingredient_id: 'breakfast_sausage', base_amount: 200, unit: 'g', scaling: 'scales', notes: 'Browned and crumbled.' },
                    { ingredient_id: 'cheese_tasty_grated', base_amount: 80, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'spinach_baby', base_amount: 60, unit: 'g', scaling: 'scales', notes: 'Chopped.' },
                    { ingredient_id: 'brown_onion', base_amount: 60, unit: 'g', scaling: 'scales', notes: 'Diced.' },
                    { ingredient_id: 'olive_oil', base_amount: 5, unit: 'g', scaling: 'fixed', notes: 'For greasing the tin.' },
                    { ingredient_id: 'salt', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'black_pepper_ground', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Preheat the oven to 180C (350F) and grease a 12-cup muffin tin. If the sausage is raw, brown and crumble it; chop the spinach and onion.', substeps: ['Preheat the oven to 180C (350F) and grease a 12-cup muffin tin. If the sausage is raw, brown and crumble it; chop the spinach and onion.'] },
                    { summary: 'Blend the eggs, cottage cheese, salt, and pepper until smooth.', substeps: ['Blend the eggs, cottage cheese, salt, and pepper until smooth.'] },
                    { summary: 'Divide the sausage, spinach, onion, and half the cheese between the cups, pour the egg mixture over to fill each 3/4 full, and top with the rest of the cheese.', substeps: ['Divide the sausage, spinach, onion, and half the cheese between the cups, pour the egg mixture over to fill each 3/4 full, and top with the rest of the cheese.'] },
                    { summary: 'Bake for 18-22 minutes until set and puffy, then cool for 5 minutes and remove.', substeps: ['Bake for 18-22 minutes until set and puffy, then cool for 5 minutes and remove.'] },
                ],
            },
        ],
    },
    protein_ice_cream: {
        slug: 'protein_ice_cream',
        display_name: 'Protein Ice Cream',
        cuisine: 'dessert',
        primary_protein: 'dairy',
        produces_servings: 1,
        eligible_slots: ['dessert', 'snack', 'post_workout'],
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'whey_protein_vanilla',
        contains_allergens: ['Dairy'],
        ...
        meal_prep: {
            ...
            storage: 'Keep frozen; let it sit 5-10 minutes to soften before scooping.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Protein Ice Cream',
                description: 'Thick, creamy high-protein ice cream blended from milk, protein powder, and a little instant pudding mix, then frozen — no ice cream machine needed.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'freezer',
                display_name: 'Blend & Freeze (no machine)',
                equipment_required: ['blender', 'freezer'],
                time_active_minutes: 5,
                time_total_minutes: 365,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'full_cream_milk', base_amount: 360, unit: 'ml', scaling: 'scales', notes: 'Lite/skim for leaner macros, or high-protein milk for more protein.' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 35, unit: 'g', scaling: 'flex', notes: 'About 1 to 1.5 scoops. Vanilla or chocolate.' },
                    { ingredient_id: 'instant_pudding_mix', base_amount: 12, unit: 'g', scaling: 'scales', notes: '1 tablespoon — the anti-icy thickener.' },
                    { ingredient_id: 'vanilla_extract', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
    ...
    cottage_cheese_ice_cream: {
        slug: 'cottage_cheese_ice_cream',
        display_name: 'Cottage Cheese Ice Cream',
        cuisine: 'dessert',
        primary_protein: 'dairy',
        produces_servings: 1,
        eligible_slots: ['dessert', 'snack', 'post_workout'],
        ...
        meal_prep: {
            strategy: 'full',
            prep_note: 'Freezer-set ahead by design — blend and freeze.',
            storage: 'Keep frozen; soften ~5 minutes before scooping.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Cottage Cheese Ice Cream',
                description: 'Surprisingly creamy, high-protein ice cream made with cottage cheese, berries, and a touch of honey — frozen until firm and scoopable.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                equipment_required: ['blender', 'freezer'],
                time_active_minutes: 5,
                time_total_minutes: 305,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'cottage_cheese', base_amount: 300, unit: 'g', scaling: 'flex', notes: 'Full-fat cottage cheese for creamiest texture.' },
                    { ingredient_id: 'mixed_berries', base_amount: 120, unit: 'g', scaling: 'scales', notes: 'Frozen or fresh — strawberries, blueberries, raspberries.' },
                    { ingredient_id: 'honey', base_amount: 25, unit: 'g', scaling: 'scales', notes: 'About 1 tablespoon for natural sweetness.' },
                    { ingredient_id: 'vanilla_extract', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'salt', base_amount: 0.5, unit: 'tsp', scaling: 'fixed', notes: 'Tiny pinch to enhance sweetness.' },
                ],
                instructions: [
                    { summary: 'Blend cottage cheese, berries, honey, vanilla, and salt until completely smooth and creamy.', substeps: ['Blend cottage cheese, berries, honey, vanilla, and salt until completely smooth and creamy.'] },
                    { summary: 'Pour into a shallow freezer-safe container and freeze for at least 5 hours until firm but scoopable.', substeps: ['Pour into a shallow freezer-safe container and freeze for at least 5 hours until firm but scoopable.'] },
                    { summary: 'Let sit at room temperature for 5 minutes to soften slightly before scooping.', substeps: ['Let sit at room temperature for 5 minutes to soften slightly before scooping.'] },
                ],
            },
        ],
    },
    chocolate_protein_mug_cake: {
        slug: 'chocolate_protein_mug_cake',
        display_name: 'Chocolate Protein Mug Cake',
        cuisine: 'dessert',
        primary_protein: 'dairy',
        produces_servings: 1,
        eligible_slots: ['dessert', 'snack', 'post_workout'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Chocolate Protein Mug Cake',
                description: 'A warm, fudgy single-serve chocolate cake made in a mug in the microwave in about 75 seconds, studded with melty chocolate chips.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 30, unit: 'g', scaling: 'flex', notes: 'Chocolate or vanilla. Acts as the "flour".' },
                    { ingredient_id: 'cocoa_powder', base_amount: 6, unit: 'g', scaling: 'scales', notes: '1 tablespoon.' },
                    { ingredient_id: 'baking_powder', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'egg_whole', base_amount: 1, unit: 'count', scaling: 'scales', notes: 'Whole egg for a moister, richer cake.' },
                    { ingredient_id: 'full_cream_milk', base_amount: 60, unit: 'ml', scaling: 'scales' },
                    { ingredient_id: 'maple_syrup', base_amount: 7, unit: 'ml', scaling: 'scales' },
                    { ingredient_id: 'chocolate_chips', base_amount: 15, unit: 'g', scaling: 'scales', notes: '1 tablespoon.' },
                    { ingredient_id: 'salt', base_amount: 0.06, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Whisk the protein powder, cocoa, baking powder, and salt together in a microwave-safe mug.', substeps: ['Whisk the protein powder, cocoa, baking powder, and salt together in a microwave-safe mug.'] },
                    { summary: 'Add the egg, milk, and maple syrup and stir to a smooth batter, then stir in the chocolate chips.', substeps: ['Add the egg, milk, and maple syrup and stir to a smooth batter, then stir in the chocolate chips.'] },
                    { summary: 'Microwave for 60-90 seconds until risen and just set, then let cool for a minute.', substeps: ['Microwave for 60-90 seconds until risen and just set, then let cool for a minute.'] },
                ],
            },
        ],
    },
    fudgy_protein_brownies: {
        slug: 'fudgy_protein_brownies',
        display_name: 'Fudgy Protein Brownies',
        cuisine: 'dessert',
        primary_protein: 'dairy',
        produces_servings: 8,
        eligible_slots: ['dessert', 'snack', 'post_workout'],
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'whey_protein_chocolate',
        contains_allergens: ['Dairy', 'Eggs', 'Nuts'],
        ...
        meal_prep: {
            ...
            storage: 'Airtight ~5 days at room temp / fridge, or freeze up to 3 months.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Fudgy Protein Brownies',
                description: 'A baked batch of rich, fudgy double-chocolate brownies made with peanut butter and chocolate protein powder. Makes 8; eat two for a bigger hit.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'peanut_butter_natural', base_amount: 128, unit: 'g', scaling: 'scales', notes: 'Smooth, no-added-sugar. Almond butter works too (becomes tree nuts).' },
                    { ingredient_id: 'whey_protein_chocolate', base_amount: 60, unit: 'g', scaling: 'flex', notes: 'Chocolate for best flavour.' },
                    { ingredient_id: 'cocoa_powder', base_amount: 30, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'egg_whole', base_amount: 2, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'maple_syrup', base_amount: 80, unit: 'ml', scaling: 'scales', notes: 'About 1/3 cup.' },
                    { ingredient_id: 'full_cream_milk', base_amount: 30, unit: 'ml', scaling: 'scales', notes: 'Loosen the batter if thick.' },
                    { ingredient_id: 'baking_powder', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'vanilla_extract', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'chocolate_chips', base_amount: 85, unit: 'g', scaling: 'scales', notes: 'About 1/2 cup; save some for the top.' },
                    { ingredient_id: 'salt', base_amount: 0.25, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Preheat the oven to 175°C (350°F) and line an 8x8 inch pan with baking paper.', substeps: ['Preheat the oven to 175°C (350°F) and line an 8x8 inch pan with baking paper.'] },
                    { summary: 'Mix the peanut butter, eggs, maple syrup, milk, and vanilla until smooth.', substeps: ['Mix the peanut butter, eggs, maple syrup, milk, and vanilla until smooth.'] },
                    { summary: 'Stir in the protein powder, cocoa, baking powder, and salt until smooth, then fold in most of the chocolate chips.', substeps: ['Stir in the protein powder, cocoa, baking powder, and salt until smooth, then fold in most of the chocolate chips.'] },
                    { summary: 'Spread into the pan, top with the remaining chips, and bake 20-25 minutes until the edges are set.', substeps: ['Spread into the pan, top with the remaining chips, and bake 20-25 minutes until the edges are set.'] },
                    { summary: 'Cool completely in the pan, then cut into 8 brownies.', substeps: ['Cool completely in the pan, then cut into 8 brownies.'] },
                ],
            },
        ],
    },
    protein_chocolate_chip_cookies: {
        slug: 'protein_chocolate_chip_cookies',
        display_name: 'Protein Chocolate Chip Cookies',
        cuisine: 'dessert',
        primary_protein: 'dairy',
        produces_servings: 10,
        eligible_slots: ['dessert', 'snack', 'post_workout'],
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'whey_protein_vanilla',
        ...
        meal_prep: {
            ...
            storage: 'Airtight ~5 days, or freeze up to 3 months.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Protein Chocolate Chip Cookies',
                description: 'Soft-baked flourless chocolate chip cookies — peanut butter, protein powder, and egg form the dough, no flour. Makes 10.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'peanut_butter_natural', base_amount: 200, unit: 'g', scaling: 'scales', notes: 'Smooth. Forms the flourless dough base.' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 50, unit: 'g', scaling: 'flex', notes: 'Vanilla or chocolate. Whey blends/casein bake softer than isolate.' },
                    { ingredient_id: 'egg_whole', base_amount: 2, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'honey', base_amount: 60, unit: 'g', scaling: 'scales', notes: 'Or coconut sugar for a more classic cookie spread.' },
                    { ingredient_id: 'baking_powder', base_amount: 0.5, unit: 'tsp', scaling: 'fixed', notes: 'Or 1/2 tsp baking soda.' },
                    { ingredient_id: 'vanilla_extract', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'chocolate_chips', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Save some to press on top.' },
                    { ingredient_id: 'salt', base_amount: 0.25, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Preheat the oven to 175°C (350°F) and line a baking tray with baking paper.', substeps: ['Preheat the oven to 175°C (350°F) and line a baking tray with baking paper.'] },
                    { summary: 'Mix the peanut butter, eggs, honey, and vanilla into a smooth paste.', substeps: ['Mix the peanut butter, eggs, honey, and vanilla into a smooth paste.'] },
                    { summary: 'Stir in the protein powder, baking powder, and salt to form a soft dough, then fold in most of the chocolate chips.', substeps: ['Stir in the protein powder, baking powder, and salt to form a soft dough, then fold in most of the chocolate chips.'] },
                    { summary: 'Scoop 10 mounds onto the tray, flatten slightly, and press the remaining chips on top.', substeps: ['Scoop 10 mounds onto the tray, flatten slightly, and press the remaining chips on top.'] },
                    { summary: 'Bake 8-10 minutes until the edges are golden, then cool on the tray to firm up.', substeps: ['Bake 8-10 minutes until the edges are golden, then cool on the tray to firm up.'] },
                ],
            },
        ],
    },
    protein_banana_bread: {
        slug: 'protein_banana_bread',
        display_name: 'Protein Banana Bread',
        cuisine: 'dessert',
        primary_protein: 'dairy',
        produces_servings: 10,
        eligible_slots: ['dessert', 'snack', 'breakfast'],
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'whey_protein_vanilla',
        contains_allergens: ['Dairy', 'Eggs'],
        ...
        meal_prep: {
            ...
            storage: 'Airtight ~4 days, or freeze sliced up to 3 months.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Protein Banana Bread',
                description: 'A moist, sliceable banana-chocolate-chip loaf made with Greek yoghurt, protein powder, and oat flour. Doubles as breakfast. Makes a 10-slice loaf.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'banana', base_amount: 360, unit: 'g', scaling: 'scales', notes: 'Very ripe — the riper the sweeter. About 3 medium bananas.' },
                    { ingredient_id: 'greek_yoghurt_plain', base_amount: 150, unit: 'g', scaling: 'scales', notes: 'Plain; keeps it moist and adds protein.' },
                    { ingredient_id: 'egg_whole', base_amount: 2, unit: 'count', scaling: 'scales' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 60, unit: 'g', scaling: 'flex', notes: 'Vanilla. Casein/blend bakes softer than isolate.' },
                    { ingredient_id: 'oat_flour', base_amount: 150, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'maple_syrup', base_amount: 60, unit: 'ml', scaling: 'scales' },
                    { ingredient_id: 'baking_powder', base_amount: 1.5, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'cinnamon_ground', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'vanilla_extract', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'chocolate_chips', base_amount: 60, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'salt', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Preheat the oven to 175°C (350°F) and line a loaf tin with baking paper.', substeps: ['Preheat the oven to 175°C (350°F) and line a loaf tin with baking paper.'] },
                    { summary: 'Mash the bananas, then whisk in the Greek yoghurt, eggs, maple syrup, and vanilla.', substeps: ['Mash the bananas, then whisk in the Greek yoghurt, eggs, maple syrup, and vanilla.'] },
                    { summary: 'Stir in the protein powder, oat flour, baking powder, cinnamon, and salt until just combined, then fold in most of the chocolate chips.', substeps: ['Stir in the protein powder, oat flour, baking powder, cinnamon, and salt until just combined, then fold in most of the chocolate chips.'] },
                    { summary: 'Pour into the tin, top with the remaining chips, and bake 40-50 minutes until a skewer comes out clean.', substeps: ['Pour into the tin, top with the remaining chips, and bake 40-50 minutes until a skewer comes out clean.'] },
                    { summary: 'Cool in the tin, then slice into 10.', substeps: ['Cool in the tin, then slice into 10.'] },
                ],
            },
        ],
    },
    edible_protein_cookie_dough: {
        slug: 'edible_protein_cookie_dough',
        display_name: 'Edible Protein Cookie Dough',
        cuisine: 'dessert',
        primary_protein: 'dairy',
        produces_servings: 3,
        eligible_slots: ['dessert', 'snack', 'post_workout'],
        ...
        meal_prep: {
            ...
            storage: 'Keeps ~5 days covered in the fridge.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Edible Protein Cookie Dough',
                description: 'Soft, scoopable eggless cookie dough you eat raw — peanut butter, protein powder, and oat flour, loaded with chocolate chips. No baking, no raw eggs.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'peanut_butter_natural', base_amount: 60, unit: 'g', scaling: 'scales', notes: 'Smooth.' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 40, unit: 'g', scaling: 'flex', notes: 'Vanilla.' },
                    { ingredient_id: 'oat_flour', base_amount: 60, unit: 'g', scaling: 'scales', notes: 'Safe raw; gives the doughy texture.' },
                    { ingredient_id: 'maple_syrup', base_amount: 30, unit: 'ml', scaling: 'scales' },
                    { ingredient_id: 'full_cream_milk', base_amount: 40, unit: 'ml', scaling: 'scales', notes: 'To loosen to a dough; add a splash more if dry.' },
                    { ingredient_id: 'chocolate_chips', base_amount: 30, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'vanilla_extract', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'salt', base_amount: 0.06, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Stir the peanut butter, maple syrup, milk, and vanilla together until smooth.', substeps: ['Stir the peanut butter, maple syrup, milk, and vanilla together until smooth.'] },
                    { summary: 'Mix in the protein powder, oat flour, and salt to form a soft, scoopable dough.', substeps: ['Mix in the protein powder, oat flour, and salt to form a soft, scoopable dough.'] },
                    { summary: 'Fold in the chocolate chips. Eat now or chill 15-30 minutes to firm up.', substeps: ['Fold in the chocolate chips. Eat now or chill 15-30 minutes to firm up.'] },
                ],
            },
        ],
    },
    no_bake_protein_cheesecake: {
        slug: 'no_bake_protein_cheesecake',
        display_name: 'No-Bake Protein Cheesecake',
        cuisine: 'dessert',
        primary_protein: 'dairy',
        produces_servings: 4,
        eligible_slots: ['dessert', 'snack'],
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'whey_protein_vanilla',
        contains_allergens: ['Dairy', 'Nuts'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'No-Bake Protein Cheesecake',
                description: 'A creamy, egg-free, no-bake cheesecake set in the fridge — blended cream cheese, cottage cheese, Greek yoghurt, and protein powder on an oat-peanut butter base, berry-topped. Makes 4.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'no_cook',
                display_name: 'No-Bake (fridge-set)',
                time_active_minutes: 15,
                time_total_minutes: 255,
                skill_min: 2,
                shortcut_level: 'scratch',
                ingredients: [
                    ...
                    { ingredient_id: 'maple_syrup', base_amount: 40, unit: 'ml', scaling: 'scales' },
                    { ingredient_id: 'vanilla_extract', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'oat_flour', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Base.' },
                    { ingredient_id: 'peanut_butter_natural', base_amount: 40, unit: 'g', scaling: 'scales', notes: 'Base binder.' },
                    { ingredient_id: 'honey', base_amount: 28, unit: 'g', scaling: 'scales', notes: 'Base.' },
                    { ingredient_id: 'mixed_berries', base_amount: 100, unit: 'g', scaling: 'scales', notes: 'Topping.' },
                ],
                instructions: [
    ...
    chocolate_protein_mousse: {
        slug: 'chocolate_protein_mousse',
        display_name: 'Chocolate Protein Mousse',
        cuisine: 'dessert',
        primary_protein: 'dairy',
        produces_servings: 1,
        eligible_slots: ['dessert', 'snack', 'post_workout'],
        ...
        meal_prep: {
            ...
            storage: 'Keeps ~3 days covered in the fridge.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Chocolate Protein Mousse',
                description: 'Rich, silky chocolate mousse made by blending cottage cheese completely smooth with cocoa and chocolate protein powder, then chilling. No cooking.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'cottage_cheese', base_amount: 200, unit: 'g', scaling: 'scales', notes: 'Full-fat or 2% blends silkiest. Blend until no curds remain.' },
                    { ingredient_id: 'whey_protein_chocolate', base_amount: 15, unit: 'g', scaling: 'flex', notes: 'About 1/2 scoop chocolate; boosts protein and thickens.' },
                    { ingredient_id: 'cocoa_powder', base_amount: 12, unit: 'g', scaling: 'scales', notes: '2 tablespoons.' },
                    { ingredient_id: 'maple_syrup', base_amount: 15, unit: 'ml', scaling: 'scales', notes: 'Adjust to taste.' },
                    { ingredient_id: 'full_cream_milk', base_amount: 20, unit: 'ml', scaling: 'scales', notes: 'To loosen if needed.' },
                    { ingredient_id: 'vanilla_extract', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'chocolate_chips', base_amount: 10, unit: 'g', scaling: 'scales', notes: 'Topping.' },
                    { ingredient_id: 'salt', base_amount: 0.06, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
    ...
    frozen_date_snickers_bark: {
        slug: 'frozen_date_snickers_bark',
        display_name: 'Frozen Date Snickers Bark',
        cuisine: 'dessert',
        primary_protein: 'dairy',
        produces_servings: 10,
        eligible_slots: ['dessert', 'snack'],
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'medjool_dates',
        contains_allergens: ['Dairy', 'Nuts'],
        ...
        meal_prep: {
            ...
            storage: 'Keep frozen; breaks into ~10 pieces and eats straight from the freezer.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Frozen Date Snickers Bark',
                description: 'The viral frozen date bark — pressed Medjool dates, a peanut-butter-and-protein layer, chopped peanuts, and a chocolate top. Tastes like a Snickers. Breaks into ~10 pieces.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'freezer',
                display_name: 'No-Bake (freezer-set)',
                equipment_required: ['freezer'],
                time_active_minutes: 10,
                time_total_minutes: 40,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'medjool_dates', base_amount: 250, unit: 'g', scaling: 'flex', notes: 'Pitted, soft. The chewy caramel-like base.' },
                    { ingredient_id: 'peanut_butter_natural', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Warmed to spread.' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 20, unit: 'g', scaling: 'scales', notes: 'Stirred into the peanut butter for the higher-protein version.' },
                    { ingredient_id: 'peanuts_roasted_unsalted', base_amount: 40, unit: 'g', scaling: 'scales', notes: 'Roughly chopped, for crunch.' },
                    { ingredient_id: 'chocolate_chips', base_amount: 80, unit: 'g', scaling: 'scales', notes: 'Melted for the top.' },
                    { ingredient_id: 'salt', base_amount: 0.12, unit: 'tsp', scaling: 'fixed', notes: 'Flaky, sprinkled on top.' },
                ],
                instructions: [
                    { summary: 'Line a tray with baking paper, then press the pitted dates into one solid overlapping layer.', substeps: ['Line a tray with baking paper, then press the pitted dates into one solid overlapping layer.'] },
                    { summary: 'Stir the protein powder into the warmed peanut butter, spread over the dates, and press in the chopped peanuts.', substeps: ['Stir the protein powder into the warmed peanut butter, spread over the dates, and press in the chopped peanuts.'] },
                    { summary: 'Melt the chocolate chips, spread over the top, and sprinkle with flaky salt.', substeps: ['Melt the chocolate chips, spread over the top, and sprinkle with flaky salt.'] },
                    { summary: 'Freeze 20-30 minutes until set, then break into about 10 pieces.', substeps: ['Freeze 20-30 minutes until set, then break into about 10 pieces.'] },
                ],
            },
        ],
    },
    palacinke: {
        slug: 'palacinke',
        display_name: 'Palačinke (Croatian Crêpes)',
        cuisine: 'dessert',
        primary_protein: 'dairy',
        produces_servings: 5,
        eligible_slots: ['dessert', 'snack', 'post_workout'],
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'flour_plain',
        ...
        meal_prep: {
            ...
            storage: 'Keeps ~3 days in the fridge (or freeze, layered); reheat briefly in a pan or microwave. Best fresh but holds up like any crepe/pancake.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Palačinke (Croatian Crêpes)',
                description: 'Thin, delicate Croatian crêpes filled with jam — 3 golden crêpes per serve, light but satisfying. A traditional European dessert.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'stovetop',
                display_name: 'Stovetop (traditional)',
                equipment_required: ['stovetop'],
                time_active_minutes: 20,
                time_total_minutes: 30,
                skill_min: 2,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'flour_plain', base_amount: 150, unit: 'g', scaling: 'flex', notes: 'About 1 cup. The base for thin, delicate crêpes.' },
                    { ingredient_id: 'egg_whole', base_amount: 2, unit: 'count', scaling: 'scales', notes: 'For richness and structure.' },
                    { ingredient_id: 'full_cream_milk', base_amount: 400, unit: 'ml', scaling: 'scales', notes: 'Creates the signature thin texture.' },
                    { ingredient_id: 'sugar_white', base_amount: 20, unit: 'g', scaling: 'scales', notes: 'Just enough for a hint of sweetness.' },
                    { ingredient_id: 'salt', base_amount: 0.25, unit: 'tsp', scaling: 'fixed', notes: 'Balances the sweetness.' },
                    { ingredient_id: 'butter_salted', base_amount: 30, unit: 'g', scaling: 'scales', notes: 'Melted, for the batter and pan.' },
                    { ingredient_id: 'jam', base_amount: 100, unit: 'g', scaling: 'scales', notes: 'Traditional filling — mixed berry or apricot work best.' },
                ],
                instructions: [
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Greek Yogurt',
                description: 'A pot of thick Greek yogurt — the easiest high-protein grab. Full-fat for more calories on a bulk.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Beef Jerky',
                description: 'The most portable high-protein grab there is — a bag of beef jerky. No fridge, no prep.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'beef_jerky', base_amount: 40, unit: 'g', scaling: 'flex', notes: 'About one small bag. Lower-sodium where possible.' },
                ],
                instructions: [
                    { summary: 'Open a bag of beef jerky and eat — choose a lower-sodium variety if you can.', substeps: ['Open a bag of beef jerky and eat — choose a lower-sodium variety if you can.'] },
                ],
            },
        ],
    },
    edamame: {
        ...
        cuisine: 'snack',
        primary_protein: 'plant',
        produces_servings: 1,
        eligible_slots: ['snack', 'post_workout'],
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'edamame',
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Edamame',
                description: 'Warm steamed edamame pods with a little salt — a high-protein, high-fibre plant snack you pop straight from the pod.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'microwave',
                display_name: 'Steam / Microwave',
                equipment_required: ['microwave'],
                time_active_minutes: 1,
                time_total_minutes: 4,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                ...
                instructions: [
                    { summary: 'Microwave the frozen edamame pods with a splash of water for 2-3 minutes until hot, then drain.', substeps: ['Microwave the frozen edamame pods with a splash of water for 2-3 minutes until hot, then drain.'] },
                    { summary: 'Sprinkle with salt and pop the beans straight from the pods.', substeps: ['Sprinkle with salt and pop the beans straight from the pods.'] },
                ],
            },
        ],
    },
    protein_shake: {
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Protein Shake',
                description: 'The fastest protein hit going — a scoop of protein powder shaken or blended with milk. The classic post-workout grab.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'no_cook',
                display_name: 'Shake & Go',
                time_active_minutes: 1,
                time_total_minutes: 1,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 35, unit: 'g', scaling: 'flex', notes: 'About 1-1.5 scoops.' },
                    { ingredient_id: 'full_cream_milk', base_amount: 350, unit: 'ml', scaling: 'scales', notes: 'Milk for more calories; water for a leaner shake.' },
                ],
                instructions: [
                    { summary: 'Add the protein powder and milk to a shaker, shake until smooth, and drink.', substeps: ['Add the protein powder and milk to a shaker, shake until smooth, and drink.'] },
                ],
            },
        ],
    },
    protein_bar: {
        ...
        min_scale: 1.0,
        max_scale: 2.0,
        flex_ingredient_id: 'protein_bar',
        contains_allergens: ['Dairy'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Protein Bar',
                description: 'A store-bought protein bar — the ultimate keep-in-your-bag grab when you need protein and have zero time.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'protein_bar', base_amount: 1, unit: 'count', scaling: 'flex', notes: 'Any brand you like; aim for 15g+ protein and a sensible sugar level.' },
                ],
                instructions: [
                    { summary: 'Unwrap a protein bar and eat — pick a brand with at least 15g protein.', substeps: ['Unwrap a protein bar and eat — pick a brand with at least 15g protein.'] },
                ],
            },
        ],
    },
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Cheese',
                description: 'A portion of cheese — block, string, or individual rounds. High-protein, high-fat, no prep.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
    ...
    hard_boiled_eggs: {
        ...
        meal_prep: {
            ...
            storage: 'Keep ~1 week in the fridge, peeled or in shell.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Hard-Boiled Eggs',
                description: 'A couple of hard-boiled eggs with a pinch of salt — cheap, portable whole-food protein. Boil a batch ahead and grab through the week.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'stovetop',
                display_name: 'Boil (prep-ahead)',
                equipment_required: ['stovetop'],
                time_active_minutes: 2,
                time_total_minutes: 12,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'egg_whole', base_amount: 2, unit: 'count', scaling: 'flex' },
                    { ingredient_id: 'salt', base_amount: 0.12, unit: 'tsp', scaling: 'fixed', notes: 'To season when eating.' },
                ],
                instructions: [
                    { summary: 'Lower the eggs into boiling water and cook for 9-10 minutes, then cool in cold water and peel.', substeps: ['Lower the eggs into boiling water and cook for 9-10 minutes, then cool in cold water and peel.'] },
                    { summary: 'Season with salt and eat. Boil a batch and keep them in the fridge for grab-and-go snacks.', substeps: ['Season with salt and eat. Boil a batch and keep them in the fridge for grab-and-go snacks.'] },
                ],
            },
        ],
    },
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Tuna Pouch',
                description: 'A ready-to-eat pouch of tuna — one of the leanest, highest protein-per-calorie snacks there is. No draining, no prep.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'tuna', base_amount: 95, unit: 'g', scaling: 'flex', notes: 'One pouch. Flavoured pouches need no extras.' },
                ],
                instructions: [
                    { summary: 'Tear open a tuna pouch and eat straight from it — flavoured pouches need nothing added.', substeps: ['Tear open a tuna pouch and eat straight from it — flavoured pouches need nothing added.'] },
                ],
            },
        ],
    },
    roasted_chickpeas: {
        slug: 'roasted_chickpeas',
        display_name: 'Roasted Chickpeas',
        cuisine: 'snack',
        primary_protein: 'plant',
        produces_servings: 3,
        eligible_slots: ['snack', 'post_workout'],
        ...
        meal_prep: {
            ...
            storage: 'Store airtight at room temp; crunchiest in the first few days.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Roasted Chickpeas',
                description: 'Crunchy oven-roasted chickpeas — a high-fibre plant snack with a satisfying crisp. Roast a can, or buy them ready-roasted.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'oven',
                display_name: 'Oven (or buy ready-roasted)',
                equipment_required: ['oven'],
                time_active_minutes: 5,
                time_total_minutes: 35,
                skill_min: 1,
                ...
                instructions: [
                    { summary: 'Preheat the oven to 200°C (400°F). Drain, rinse, and thoroughly dry the chickpeas.', substeps: ['Preheat the oven to 200°C (400°F). Drain, rinse, and thoroughly dry the chickpeas.'] },
                    { summary: 'Toss with the oil and salt, spread on a tray, and roast 25-30 minutes, shaking halfway, until crunchy.', substeps: ['Toss with the oil and salt, spread on a tray, and roast 25-30 minutes, shaking halfway, until crunchy.'] },
                    { summary: 'Cool (they crisp up further as they cool) and store in an airtight container.', substeps: ['Cool (they crisp up further as they cool) and store in an airtight container.'] },
                ],
            },
        ],
    },
    no_bake_protein_balls: {
        slug: 'no_bake_protein_balls',
        display_name: 'No-Bake Protein Balls',
        cuisine: 'snack',
        primary_protein: 'dairy',
        produces_servings: 12,
        eligible_slots: ['snack', 'post_workout'],
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'whey_protein_vanilla',
        ...
        meal_prep: {
            ...
            storage: 'Keep ~1 week in the fridge, or freeze up to 3 months.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'No-Bake Protein Balls',
                description: 'Bite-sized no-bake energy balls — peanut butter, oats, protein powder, honey, and chocolate chips rolled and chilled. Make a batch, grab all week.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'no_cook',
                display_name: 'No-Bake (roll & chill)',
                time_active_minutes: 10,
                time_total_minutes: 40,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'peanut_butter_natural', base_amount: 130, unit: 'g', scaling: 'scales', notes: 'Smooth; the binder.' },
                    { ingredient_id: 'rolled_oats_raw', base_amount: 120, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'whey_protein_vanilla', base_amount: 60, unit: 'g', scaling: 'flex', notes: 'Vanilla or chocolate.' },
                    { ingredient_id: 'honey', base_amount: 60, unit: 'g', scaling: 'scales', notes: 'Or maple syrup.' },
                    { ingredient_id: 'chocolate_chips', base_amount: 40, unit: 'g', scaling: 'scales' },
                    { ingredient_id: 'vanilla_extract', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Mix the peanut butter, honey, and vanilla until smooth.', substeps: ['Mix the peanut butter, honey, and vanilla until smooth.'] },
                    { summary: 'Stir in the oats, protein powder, and chocolate chips to a stiff dough — add a splash of milk if dry.', substeps: ['Stir in the oats, protein powder, and chocolate chips to a stiff dough — add a splash of milk if dry.'] },
                    { summary: 'Roll into about 12 balls and chill 30 minutes to firm up.', substeps: ['Roll into about 12 balls and chill 30 minutes to firm up.'] },
                ],
            },
        ],
    },
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Mixed Nuts',
                description: 'A handful of mixed nuts — one of the most calorie-dense, easy-surplus snacks for a bulk. Almonds, cashews, walnuts and more.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'mixed_nuts', base_amount: 40, unit: 'g', scaling: 'flex', notes: 'About a small handful. Calorie-dense — easy to overdo, easy to use for surplus.' },
                ],
                instructions: [
                    { summary: 'Grab a handful of mixed nuts and eat — unsalted or lightly salted.', substeps: ['Grab a handful of mixed nuts and eat — unsalted or lightly salted.'] },
                ],
            },
        ],
    },
    trail_mix: {
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Trail Mix',
                description: 'A scoop of trail mix — nuts, dried fruit, and chocolate. The portable, calorie-dense grab that mixes protein, carbs, and fat in one handful.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'no_cook',
                display_name: 'Grab & Go (or mix your own)',
                time_active_minutes: 1,
                time_total_minutes: 1,
                skill_min: 1,
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'mixed_nuts', base_amount: 30, unit: 'g', scaling: 'flex' },
                    { ingredient_id: 'dried_fruit', base_amount: 20, unit: 'g', scaling: 'scales', notes: 'Raisins, cranberries, chopped apricot.' },
                    { ingredient_id: 'chocolate_chips', base_amount: 10, unit: 'g', scaling: 'scales', notes: 'Dark chocolate chips or chopped dark chocolate.' },
                ],
                instructions: [
                    { summary: 'Grab a handful of trail mix, or mix your own from nuts, dried fruit, and chocolate.', substeps: ['Grab a handful of trail mix, or mix your own from nuts, dried fruit, and chocolate.'] },
                ],
            },
        ],
    },
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Banana',
                description: 'A banana — the original grab-and-go fuel. Fast carbs and potassium, ideal around training.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'banana', base_amount: 120, unit: 'g', scaling: 'flex' },
                ],
                instructions: [
                    { summary: 'Peel a banana and eat — great before or after a session for quick carbs.', substeps: ['Peel a banana and eat — great before or after a session for quick carbs.'] },
                ],
            },
        ],
    },
    dried_fruit: {
        ...
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'dried_fruit',
        contains_allergens: [],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Dried Fruit',
                description: 'A small handful of dried fruit — concentrated, fast carbs in a tiny portable package. Great quick energy around training.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'dried_fruit', base_amount: 40, unit: 'g', scaling: 'flex', notes: 'Raisins, apricots, dates, cranberries. Calorie-dense — a small handful is a serving.' },
                ],
                instructions: [
                    { summary: 'Grab a small handful of dried fruit and eat — quick, concentrated carbs.', substeps: ['Grab a small handful of dried fruit and eat — quick, concentrated carbs.'] },
                ],
            },
        ],
    },
    dark_chocolate: {
        ...
        primary_protein: 'plant',
        produces_servings: 1,
        eligible_slots: ['snack'],
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'dark_chocolate',
        contains_allergens: ['Dairy'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Dark Chocolate',
                description: 'A couple of squares of dark chocolate — the calorie-dense treat snack for when you want something sweet without derailing the day.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'dark_chocolate', base_amount: 30, unit: 'g', scaling: 'flex', notes: 'About 2-3 squares of a 70%+ bar.' },
                ],
                instructions: [
                    { summary: 'Break off a couple of squares of dark chocolate and enjoy — 70%+ for less sugar.', substeps: ['Break off a couple of squares of dark chocolate and enjoy — 70%+ for less sugar.'] },
                ],
            },
        ],
    },
    teriyaki_chicken_rice_bowl: {
        slug: 'teriyaki_chicken_rice_bowl',
        display_name: 'Teriyaki Chicken Rice Bowl',
        cuisine: 'asian',
        primary_protein: 'chicken',
        produces_servings: 4,
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Teriyaki Chicken Rice Bowl',
                description: 'A fast one-pan teriyaki chicken bowl over jasmine rice with steamed broccoli, built for bulking — 200g chicken per portion over a honey-glaze rice base. Makes 4 meal-prep portions.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                ingredients: [
                    ...
                    { ingredient_id: 'cornstarch', base_amount: 16, unit: 'g', scaling: 'scales', notes: '2 tsp for velveting + 1.5 tbsp for the sauce.' },
                    { ingredient_id: 'oyster_sauce', base_amount: 45, unit: 'ml', scaling: 'scales' },
                    { ingredient_id: 'chinese_cooking_wine', base_amount: 30, unit: 'ml', scaling: 'scales' },
                    { ingredient_id: 'brown_sugar', base_amount: 12, unit: 'g', scaling: 'scales' },
    ...
    thai_basil_chicken: {
        ...
        min_scale: 0.5,
        max_scale: 2.0,
        contains_allergens: ['Shellfish', 'Fish', 'Soy', 'Eggs', 'Gluten/Wheat'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Thai Basil Chicken over Rice',
                description: 'Chicken mince stir-fried with garlic, chilli, and holy basil in a salty-sweet sauce, over jasmine rice. Fast, punchy, high-protein.',
            ...
            {
                id: 'fried_egg',
                display_name: 'Thai Basil Chicken with Fried Egg',
                description: 'The classic Pad Krapow finish — the same dish topped with a crispy-edged fried egg.',
                is_stunt_plate: false,
                base_serving_multiplier: 1.0,
                equipment_required: ['stovetop'],
                additional_ingredients: [
    ...
    beef_bulgogi_bowl: {
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Beef Bulgogi over Jasmine Rice',
                description: 'Korean BBQ beef — thinly sliced beef in a sweet-savoury soy-sesame-garlic marinade, seared hot until caramelised, over jasmine rice with spring onion and sesame. A sweeter, nuttier counterpart to the beef & broccoli stir-fry.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
    ...
    spaghetti_carbonara: {
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Spaghetti Carbonara',
                description: 'Classic Roman carbonara — spaghetti tossed with crispy cured pork and a glossy egg-and-cheese sauce emulsified with starchy pasta water, finished with lots of black pepper. No cream. Cook fresh and eat immediately; the sauce does not store or reheat.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                id: 'stovetop',
                display_name: 'Stovetop (cook fresh)',
                equipment_required: ['stovetop'],
                time_active_minutes: 15,
                time_total_minutes: 15,
                skill_min: 3,
                ...
                instructions: [
                    { summary: 'Bring a pot of well-salted water to the boil and cook the spaghetti al dente. Reserve a cup of the starchy pasta water before draining.', substeps: ['Bring a pot of well-salted water to the boil and cook the spaghetti al dente. Reserve a cup of the starchy pasta water before draining.'] },
                    { summary: 'In a cold pan brought up to medium-high, render the bacon until crisp, keeping the rendered fat.', substeps: ['In a cold pan brought up to medium-high, render the bacon until crisp, keeping the rendered fat.'] },
                    { summary: 'Beat the whole egg plus extra yolk with the grated parmesan and lots of black pepper into a thick paste.', substeps: ['Beat the whole egg plus extra yolk with the grated parmesan and lots of black pepper into a thick paste.'] },
                    { summary: 'Off the heat, toss the hot drained pasta with the pork and its fat, then stir through the egg-cheese mix, loosening with splashes of pasta water until glossy and creamy. Keep the pan off direct heat so the egg emulsifies rather than scrambles.', substeps: ['Off the heat, toss the hot drained pasta with the pork and its fat, then stir through the egg-cheese mix, loosening with splashes of pasta water until glossy and creamy. Keep the pan off direct heat so the egg emulsifies rather than scrambles.'] },
                    { summary: 'Serve immediately, topped with extra cheese and black pepper.', substeps: ['Serve immediately, topped with extra cheese and black pepper.'] },
                ],
            },
        ],
    },
    sheet_pan_salmon_potatoes: {
        slug: 'sheet_pan_salmon_potatoes',
        display_name: 'Sheet-Pan Lemon-Garlic Salmon & Potatoes',
        ...
        min_scale: 0.5,
        max_scale: 2.0,
        flex_ingredient_id: 'salmon_fillet',
        ...
        meal_prep: {
            ...
            storage: 'Keeps ~3 days in the fridge; reheat gently and eat within a couple of days for best salmon texture.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Salmon, Roast Potatoes & Greens',
                description: 'One-tray baked salmon with golden roast potatoes and broccoli, finished with a lemon-garlic butter. Bright, savoury, and calorie-dense from the salmon\'s natural fat plus starchy potatoes. Makes 4.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'salmon_fillet', base_amount: 800, unit: 'g', scaling: 'flex', notes: '4 fillets, ~200g each.' },
                    { ingredient_id: 'potato_baby_chat', base_amount: 800, unit: 'g', scaling: 'scales', notes: 'Baby/new potatoes halved, or any potato quartered.' },
                    { ingredient_id: 'broccoli', base_amount: 400, unit: 'g', scaling: 'scales', notes: 'Florets; green beans or asparagus swap in cleanly.' },
                    { ingredient_id: 'olive_oil', base_amount: 28, unit: 'g', scaling: 'scales', notes: 'For the potatoes.' },
                ...
                instructions: [
                    { summary: 'Heat the oven to 200°C (400°F).', substeps: ['Heat the oven to 200°C (400°F).'] },
                    { summary: 'Toss the halved potatoes with olive oil, salt, pepper, and a little garlic, spread on a sheet pan, and roast 15-20 minutes for a head start.', substeps: ['Toss the halved potatoes with olive oil, salt, pepper, and a little garlic, spread on a sheet pan, and roast 15-20 minutes for a head start.'] },
                    { summary: 'Make the lemon-garlic butter: melt the butter with the remaining minced garlic, lemon juice, and parsley.', substeps: ['Make the lemon-garlic butter: melt the butter with the remaining minced garlic, lemon juice, and parsley.'] },
                    { summary: 'Push the potatoes aside, add the salmon (skin-side down if skin-on) and broccoli to the tray, spoon the lemon-garlic butter over the salmon and veg, and season.', substeps: ['Push the potatoes aside, add the salmon (skin-side down if skin-on) and broccoli to the tray, spoon the lemon-garlic butter over the salmon and veg, and season.'] },
                    { summary: 'Return to the oven 12-15 minutes until the salmon flakes easily and the potatoes are golden.', substeps: ['Return to the oven 12-15 minutes until the salmon flakes easily and the potatoes are golden.'] },
                    { summary: 'Finish with a squeeze of lemon.', substeps: ['Finish with a squeeze of lemon.'] },
                ],
            },
        ],
    },
    chicken_fajita_bowl: {
        slug: 'chicken_fajita_bowl',
        display_name: 'Chicken Fajita Bowl',
        cuisine: 'mexican',
        primary_protein: 'chicken',
        produces_servings: 4,
        eligible_slots: ['lunch', 'dinner', 'second_lunch', 'early_dinner'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Chicken Fajita Bowl',
                description: 'Seasoned chicken with peppers and onions over jasmine rice, topped with black beans and lime. Perfect for meal prep.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
    ...
    spicy_chipotle_chicken_burrito: {
        ...
        meal_prep: {
            ...
            storage: 'Filling keeps ~4 days in the fridge or freezes up to 3 months; wrap or bowl fresh.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Spicy Chipotle Chicken Burrito',
                description: 'Smoky chipotle-spiced chicken thigh with rice, black beans, cheese, and salsa wrapped in a large tortilla. Default heat from smoked paprika, chilli powder, and cayenne.',
                is_stunt_plate: false,
                base_serving_multiplier: 1.0,
                additional_ingredients: [
            ...
            {
                id: 'extra_hot',
                display_name: 'Spicy Chipotle Chicken Burrito (Extra Hot)',
                description: 'The same burrito with chipotle in adobo blended through for serious heat. Macros and look match the standard — only the spice changes.',
                is_stunt_plate: false,
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                    { ingredient_id: 'tortilla_large', base_amount: 4, unit: 'count', scaling: 'scales' },
            ...
            {
                id: 'burrito_bowl',
                display_name: 'Spicy Chipotle Chicken Burrito Bowl',
                description: 'The same filling served as a bowl — no tortilla. Lower-carb, lighter.',
                is_stunt_plate: false,
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [
    ...
    chicken_shawarma: {
        ...
        meal_prep: {
            strategy: 'partial',
            prep_note: 'Cook the marinated chicken ahead; make the fresh salad and garlic-yoghurt sauce and warm the rice or flatbread day-of. Carb check: the rice (rice_bowl) and tortilla (wrap) are plate ingredients with no cook step, done fresh per serve; the salad and yoghurt sauce are made in the method, also day-of.',
            storage: 'Cooked chicken keeps ~4 days in the fridge or freezes up to 3 months; assemble salad, sauce and carb fresh.',
        },
        plates: [
            {
                id: 'wrap',
    ...
    satay_chicken: {
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Satay Chicken over Jasmine Rice',
                description: 'Velveted chicken seared with charred onion in a creamy peanut-coconut satay sauce, over jasmine rice. Aussie-Chinese-restaurant style with a hint of curry powder (not Thai skewer satay). Rich and calorie-dense from the peanut butter and coconut milk. Makes 4.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
    ...
    honey_chicken: {
        ...
        meal_prep: {
            strategy: 'partial',
            prep_note: 'Cook the rice and pan-crisp the chicken ahead; warm the glaze and toss the chicken through it just before serving (the recipe calls this out for crispness). Carb check: the rice is cooked in the method (cook-ahead); the day-of element is the glaze finish, also in the method, not a plate. Note: the crisp benefit is marginal once the chicken has been refrigerated, so this is defensibly `full` if you do not mind softer chicken.',
            storage: 'Rice and chicken keep ~4 days in the fridge; the glaze keeps ~1 week — toss together when reheating.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Honey Chicken over Jasmine Rice',
                description: 'Chinese-takeaway honey chicken — cornstarch-coated pan-crisped chicken tossed in a glossy honey-soy glaze, over jasmine rice. Lighter pan-fried version for meal prep (deep-fried battered is the indulgent alternative). Makes 4.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
    ...
    chicken_mac_and_cheese: {
        slug: 'chicken_mac_and_cheese',
        display_name: 'Chicken Mac and Cheese',
        cuisine: 'australian',
        primary_protein: 'chicken',
        produces_servings: 4,
        eligible_slots: ['lunch', 'dinner'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Chicken Mac and Cheese',
                description: 'Creamy baked macaroni with diced chicken in a high-protein cheese sauce (blended cottage cheese + milk + cheddar), topped with cheese and baked golden. The comfort/mass main for hitting a surplus when appetite is the limiter. Makes 4.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                ingredients: [
                    ...
                    { ingredient_id: 'butter_salted', base_amount: 20, unit: 'g', scaling: 'scales', notes: 'Optional roux.' },
                    { ingredient_id: 'flour_plain', base_amount: 20, unit: 'g', scaling: 'scales', notes: 'Optional roux (skip if using the blended-cottage-cheese method).' },
                    { ingredient_id: 'garlic_powder', base_amount: 1, unit: 'tsp', scaling: 'scales' },
                    { ingredient_id: 'onion_powder', base_amount: 1, unit: 'tsp', scaling: 'scales' },
                    { ingredient_id: 'paprika_smoked', base_amount: 1, unit: 'tsp', scaling: 'scales', notes: 'Smoked preferred.' },
                    { ingredient_id: 'salt', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'black_pepper_ground', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
                    { summary: 'Cook the macaroni to just under al dente, then drain.', substeps: ['Cook the macaroni to just under al dente, then drain.'] },
                    { summary: 'Cook the chicken (sear diced, or use pre-cooked shredded) and season.', substeps: ['Cook the chicken (sear diced, or use pre-cooked shredded) and season.'] },
                    { summary: 'Make the cheese sauce: blend the cottage cheese with the milk, warm it, then melt in most of the grated cheese with the garlic powder, onion powder, paprika, salt, and pepper. (Or build a roux: butter + flour + milk, then cheese — the cottage-cheese route is higher-protein.)', substeps: ['Make the cheese sauce: blend the cottage cheese with the milk, warm it, then melt in most of the grated cheese with the garlic powder, onion powder, paprika, salt, and pepper. (Or build a roux: butter + flour + milk, then cheese — the cottage-cheese route is higher-protein.)'] },
                    { summary: 'Fold the pasta and chicken through the sauce.', substeps: ['Fold the pasta and chicken through the sauce.'] },
                    { summary: 'Transfer to a baking dish and top with the remaining grated cheese (and breadcrumbs if using).', substeps: ['Transfer to a baking dish and top with the remaining grated cheese (and breadcrumbs if using).'] },
                    { summary: 'Bake about 20 minutes at 180-200°C until golden and bubbling.', substeps: ['Bake about 20 minutes at 180-200°C until golden and bubbling.'] },
                ],
            },
        ],
    },
    turkey_meatballs_spaghetti: {
        slug: 'turkey_meatballs_spaghetti',
        display_name: 'Turkey Meatballs & Spaghetti',
        cuisine: 'italian',
        ...
        meal_prep: {
            strategy: 'partial',
            prep_note: 'Bake the meatballs and simmer the sauce ahead and store them together; boil fresh spaghetti per meal. Carb check: the spaghetti is not cooked in the method — the recipe and description direct cooking it fresh ("store meatballs and sauce separately, reheat with fresh pasta"), so the pasta is the day-of element.',
            storage: 'Meatballs in sauce keep ~4 days in the fridge or freeze up to 3 months; cook pasta fresh each time.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Turkey Meatballs & Spaghetti',
                description: 'Lean turkey meatballs in a rich tomato sauce over spaghetti. High-protein Italian comfort meal perfect for batch prep. Store cooked meatballs and sauce separately, reheat with fresh pasta.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Tuna Pasta Bake',
                description: 'Pasta and canned tuna in a creamy high-protein cheese sauce (blended cottage cheese + milk + cheddar) with peas and sweetcorn, baked golden under a cheese top. The cheapest, most pantry-friendly meal on the list — no fresh shopping needed. Makes 4.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                ingredients: [
                    ...
                    { ingredient_id: 'garlic_clove', base_amount: 2, unit: 'cloves', scaling: 'scales', notes: 'Optional if using fresh.' },
                    { ingredient_id: 'brown_onion', base_amount: 150, unit: 'g', scaling: 'scales', notes: 'Optional; soften first. ~1 medium onion.' },
                    { ingredient_id: 'peas', base_amount: 150, unit: 'g', scaling: 'scales', notes: 'Frozen; broccoli swaps in.' },
                ...
                instructions: [
                    { summary: 'Cook the pasta to just under al dente, then drain.', substeps: ['Cook the pasta to just under al dente, then drain.'] },
                    { summary: 'Make the sauce: blend the cottage cheese with the milk, warm through, then melt in most of the grated cheese with the herbs, salt, and pepper (soften the garlic and onion in oil first if using fresh).', substeps: ['Make the sauce: blend the cottage cheese with the milk, warm through, then melt in most of the grated cheese with the herbs, salt, and pepper (soften the garlic and onion in oil first if using fresh).'] },
                    { summary: 'Fold through the drained tuna, peas, sweetcorn, and pasta.', substeps: ['Fold through the drained tuna, peas, sweetcorn, and pasta.'] },
                    { summary: 'Tip into a baking dish and top with the remaining cheese (and breadcrumbs if using).', substeps: ['Tip into a baking dish and top with the remaining cheese (and breadcrumbs if using).'] },
                    { summary: 'Bake about 20 minutes at 200°C until golden and bubbling.', substeps: ['Bake about 20 minutes at 200°C until golden and bubbling.'] },
                ],
            },
        ],
    },
    lamb_kofta: {
        ...
        meal_prep: {
            strategy: 'partial',
            prep_note: 'Grill the koftas ahead; make the fresh salad and garlic-yoghurt sauce and warm the rice or flatbread day-of. Carb check: the rice (rice_bowl) and tortilla (wrap) are plate ingredients done fresh per serve; the salad and garlic-yoghurt sauce are made in the method, also day-of.',
            storage: 'Koftas keep ~4 days in the fridge or freeze up to 3 months; assemble salad, sauce and carb fresh.',
        },
        plates: [
            {
                id: 'rice_bowl',
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Sheet-Pan Sausage & Veg',
                description: 'Sausages, potatoes, onion, peppers, and broccoli tossed in oil and herbs and roasted on one tray. The lowest-effort meal on the list — chop, toss, roast. Default leaner chicken/turkey sausage; pork is the richer option. Makes 4.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'sausage', base_amount: 800, unit: 'g', scaling: 'flex', notes: 'Chicken/turkey (default, leaner) or pork (richer). ~200g per serving (~2-3 sausages).' },
                    { ingredient_id: 'potato_baby_chat', base_amount: 1200, unit: 'g', scaling: 'scales', notes: 'Baby/new potatoes halved; generous (300g/serve) for bulking carbs.' },
                    { ingredient_id: 'brown_onion', base_amount: 300, unit: 'g', scaling: 'scales', notes: 'Chunked; red onion fine. ~2 medium onions.' },
    ...
    honey_soy_salmon_noodles: {
        slug: 'honey_soy_salmon_noodles',
        display_name: 'Honey Soy Salmon Noodle Bowl',
        cuisine: 'asian',
        primary_protein: 'fish',
        produces_servings: 4,
        eligible_slots: ['lunch', 'dinner'],
        ...
        plates: [
            {
                id: 'standard',
                display_name: 'Honey Soy Salmon Noodle Bowl',
                description: 'Salmon in a glossy honey-soy-garlic-ginger glaze over noodles with roasted broccoli. A sweet-savoury Asian counterpart to the Mediterranean sheet-pan salmon — completely different profile. Makes 4.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
    ...
    carne_asada_bowl: {
        ...
        meal_prep: {
            ...
            storage: 'Keeps ~4 days in the fridge or freezes up to 3 months; slice the rested steak thin against the grain.',
        },
        plates: [
            {
                id: 'standard',
                display_name: 'Carne Asada Bowl',
                description: 'Citrus-marinated grilled steak, sliced thin against the grain, over cilantro-lime rice with black beans, corn, pico, and cheese. The first whole-cut beef dish — a charred, citrusy contrast to the soy-glaze beef meals. Makes 4.',
                base_serving_multiplier: 1.0,
                additional_ingredients: [],
                additional_instructions: [],
                assembly_time_minutes: 0,
    ...
    chicken_schnitzel: {
        ...
        meal_prep: {
            strategy: 'partial',
            prep_note: 'Crumb and fry the schnitzels ahead; finish each plate day-of. Carb check: the crumbed cutlet is the cook-ahead core (method); each plate carb and finish is genuinely day-of in its additional_instructions — roast potatoes (plate), build the roll (roll), or sauce-cheese-and-melt (parma). Reheat the schnitzel in a hot oven to bring the crumb back.',
            storage: 'Cooked schnitzels keep ~3-4 days in the fridge or freeze up to 2 months; re-crisp in the oven, never the microwave.',
        },
        plates: [
            {
                id: 'plate',
                display_name: 'Schnitzel Plate',
                description: 'Plain crumbed chicken schnitzel with salad or potatoes, hot or cold, lemon to serve. The lean, simple option.',
                base_serving_multiplier: 1.0,
                equipment_required: ['oven'],
                additional_ingredients: [
            ...
            {
                id: 'parma',
                display_name: 'Chicken Parma',
                description: 'Schnitzel topped with tomato/pasta sauce, melted cheese, and jalapenos, baked or grilled to melt, with a potato or salad base.',
                base_serving_multiplier: 1.0,
                equipment_required: ['oven'],
                additional_ingredients: [
        ...
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'chicken_breast', base_amount: 800, unit: 'g', scaling: 'flex', notes: 'Sliced thin/pounded to ~1/2cm. 200g/serve.' },
                    { ingredient_id: 'flour_plain', base_amount: 40, unit: 'g', scaling: 'scales', notes: 'Seasoned, for dredging.' },
                    { ingredient_id: 'egg_whole', base_amount: 2, unit: 'count', scaling: 'scales', notes: 'Beaten.' },
                    { ingredient_id: 'breadcrumbs', base_amount: 100, unit: 'g', scaling: 'scales', notes: 'Panko = crispier.' },
                    { ingredient_id: 'olive_oil', base_amount: 55, unit: 'g', scaling: 'scales', notes: 'Shallow-fry; ~12g absorbed/serve (most drains). Oven-bake w/ spray for ~10g less fat/serve.' },
                    { ingredient_id: 'garlic_powder', base_amount: 1, unit: 'tsp', scaling: 'scales', notes: 'In the crumb/flour.' },
                    { ingredient_id: 'paprika_sweet', base_amount: 1, unit: 'tsp', scaling: 'scales', notes: 'In the crumb/flour.' },
                    { ingredient_id: 'salt', base_amount: 1, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'black_pepper_ground', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
    ...
    beef_ragu_gnocchi: {
        ...
        meal_prep: {
            strategy: 'partial',
            prep_note: 'Slow-braise and shred the ragu ahead; boil fresh gnocchi to packet and toss through day-of. Carb check: the gnocchi-boiling step lives in the final instruction of the method (not a plate), so it does not split at the plate boundary — but gnocchi reheats poorly and goes gummy, so treat it as day-of regardless.',
            storage: 'Ragu keeps ~4 days in the fridge or freezes up to 3 months; cook gnocchi fresh per serve.',
        },
        plates: [
            {
                id: 'standard',
    ...
    cevapi: {
        ...
        meal_prep: {
            ...
            storage: 'Cevapi keep ~4 days in the fridge or freeze up to 3 months; assemble bread/rice, onion, ajvar and salad fresh.',
        },
        plates: [
            {
                id: 'flatbread',
                display_name: 'Ćevapi with Flatbread',
                description: 'Grilled garlicky-paprika minced-meat sausages in warm flatbread with raw onion and ajvar (red pepper relish) — the traditional Balkan serve.',
                is_stunt_plate: false,
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                ...
                image_filename: 'Ćevapi with Flatbread (flatbread).png',
                photo_url: undefined,
            },
            {
                id: 'rice_plate',
                display_name: 'Ćevapi Rice Plate',
                description: 'The same grilled cevapi over rice with onion, ajvar, and salad — the non-bread, leaner option.',
                is_stunt_plate: false,
                base_serving_multiplier: 1.0,
                additional_ingredients: [
                ...
                image_filename: 'Ćevapi Rice Plate (rice_plate).png',
                photo_url: undefined,
            },
        ],
        methods: [
            {
                ...
                shortcut_level: 'scratch',
                ingredients: [
                    { ingredient_id: 'beef_mince_regular', base_amount: 500, unit: 'g', scaling: 'flex', notes: 'Lean beef preferred; part of the blend. ~200g total mince/serve.' },
                    { ingredient_id: 'lamb_mince', base_amount: 300, unit: 'g', scaling: 'scales', notes: 'The authentic blend is beef + lamb (+ pork). All-beef or beef-pork works everywhere; lamb/pork raise fat.' },
                    { ingredient_id: 'brown_onion', base_amount: 150, unit: 'g', scaling: 'scales', notes: 'Grated into the mix — key for moisture (raw red onion to serve).' },
                    { ingredient_id: 'garlic_clove', base_amount: 6, unit: 'cloves', scaling: 'scales', notes: 'Heavy hand — the signature.' },
                    { ingredient_id: 'paprika_sweet', base_amount: 4, unit: 'tsp', scaling: 'scales', notes: 'Sweet or smoked — the heart of the flavour.' },
                    { ingredient_id: 'bicarb_soda', base_amount: 0.5, unit: 'tsp', scaling: 'fixed', notes: 'Springy-tender texture — do not skip.' },
                    { ingredient_id: 'ajvar', base_amount: 160, unit: 'g', scaling: 'scales', notes: 'To serve.' },
                    { ingredient_id: 'cherry_tomatoes', base_amount: 150, unit: 'g', scaling: 'scales', notes: 'Salad (rice plate).' },
                    { ingredient_id: 'cucumber', base_amount: 150, unit: 'g', scaling: 'scales', notes: 'Salad (rice plate).' },
                    { ingredient_id: 'salt', base_amount: 1.5, unit: 'tsp', scaling: 'fixed' },
                    { ingredient_id: 'black_pepper_ground', base_amount: 0.5, unit: 'tsp', scaling: 'fixed' },
                ],
                instructions: [
