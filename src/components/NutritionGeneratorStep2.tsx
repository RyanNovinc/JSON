...
import { getMealPlanReviewPrompt } from '../data/mealPlanningPrompt';
import { useTheme } from '../contexts/ThemeContext';

interface NutritionGeneratorStep2Props {
  onNext: () => void;
  onBack: () => void;
}

export default function NutritionGeneratorStep2({ onNext, onBack }: NutritionGeneratorStep2Props) {
      ...
      <Animated.View style={{ 
        ...
        <View style={styles.content}>
          <View style={styles.centerContent}>
            ...
            <Text style={styles.hintText}>Ask AI to review and improve your meal plan</Text>
          </View>
        </View>
