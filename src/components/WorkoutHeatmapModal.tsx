...
// ──────────────────────────────────────────────────────────────────
// Muscle mapping & contribution math
// ──────────────────────────────────────────────────────────────────
...
interface WorkoutHeatmapModalProps {
  visible: boolean;
  onClose: () => void;
  exercises: any[];
  themeColor: string;
...
export default function WorkoutHeatmapModal({
  visible,
  onClose,
  exercises,
  themeColor,
}: WorkoutHeatmapModalProps) {
  ...
  const muscleBreakdown = React.useMemo(() => {
  ...
  const maxEffectiveSets = React.useMemo(
