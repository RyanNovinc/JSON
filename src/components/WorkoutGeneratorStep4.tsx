...
interface WorkoutGeneratorStep4Props {
  onBack: () => void;
  onImportSuccess: (program: any) => void;
  onExitSlideMode: () => void;
}

export default function WorkoutGeneratorStep4({ onBack, onImportSuccess, onExitSlideMode }: WorkoutGeneratorStep4Props) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.centerContent}>
          ...
          <Text style={styles.mainTitle}>Import and Start Training</Text>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { borderColor: themeColor }]}>
            ...
            <Text style={styles.modalText}>
              Now that you have your workout plan, go back to the import screen and:
            </Text>
            
            <View style={styles.optionsList}>
              <View style={styles.optionItem}>
                <Ionicons name="clipboard" size={20} color={themeColor} />
