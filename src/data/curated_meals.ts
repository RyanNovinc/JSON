...
export const CURATED_MEALS: Record<MealSlug, CuratedMeal> = {
  ...
  brekkie_grow: {
    ...
    produces_servings: 1,
    eligible_slots: ['breakfast', 'brunch', 'pre_workout', 'post_workout'],
    min_scale: 0.6,
    max_scale: 1.3,
  ...
  choc_muscle_maxx: {
    ...
    primary_protein: 'dairy',
    produces_servings: 1,
    eligible_slots: ['breakfast', 'pre_workout', 'post_workout'],
    min_scale: 0.6,
    max_scale: 1.3,
  ...
  energy_lift_heavy: {
    ...
    primary_protein: 'dairy',
    produces_servings: 1,
    eligible_slots: ['breakfast', 'pre_workout'],
    min_scale: 0.6,
    max_scale: 1.3,
    contains_allergens: ['Dairy'],
  ...
  mornin_muscle: {
    ...
    primary_protein: 'dairy',
    produces_servings: 1,
    eligible_slots: ['breakfast', 'brunch', 'pre_workout'],
    min_scale: 0.6,
    max_scale: 1.3,
    contains_allergens: ['Dairy', 'Nuts'],
  ...
  protein_ice_cream: {
    ...
    primary_protein: 'dairy',
    produces_servings: 1,
    eligible_slots: ['dessert', 'post_workout'],
    min_scale: 0.5,
    max_scale: 2.0,
  ...
  protein_banana_bread: {
    ...
    primary_protein: 'dairy',
    produces_servings: 10,
    eligible_slots: ['dessert', 'breakfast'],
    min_scale: 0.5,
    max_scale: 2.0,
    flex_ingredient_id: 'whey_protein_vanilla',
    contains_allergens: ['Dairy', 'Eggs'],
  ...
  steamed_rice: {
    ...
    min_scale: 0.5,
    max_scale: 2.0,
    flex_ingredient_id: 'jasmine_rice',
    contains_allergens: [],
    image_filename: 'steamed_rice.png',
    photo_url: undefined,
    meal_prep: { strategy: 'none', reason: 'Quick carb base — cook fresh in minutes.' },
    plates: [
      {
        id: 'standard',
        display_name: 'Steamed Rice',
        description: 'A simple bowl of steamed white or jasmine rice — clean, fast carbs that digest easily.',
        base_serving_multiplier: 1.0,
        additional_ingredients: [],
        additional_instructions: [],
        assembly_time_minutes: 0,
  ...
  steamed_mixed_veg: {
    slug: 'steamed_mixed_veg',
    display_name: 'Steamed Mixed Vegetables',
    cuisine: 'snack',
    primary_protein: 'plant',
    produces_servings: 1,
    eligible_slots: ['snack', 'post_workout'],
    min_scale: 0.5,
    max_scale: 2.0,
    flex_ingredient_id: 'broccoli',
    contains_allergens: [],
    image_filename: 'steamed_mixed_veg.png',
    photo_url: undefined,
    meal_prep: { strategy: 'none', reason: 'Fresh vegetables — steam and eat immediately.' },
    plates: [
      {
        id: 'standard',
        display_name: 'Steamed Mixed Vegetables',
        description: 'A bowl of steamed mixed vegetables — broccoli, carrots, cauliflower. High fibre, low calories.',
        base_serving_multiplier: 1.0,
        additional_ingredients: [],
        additional_instructions: [],
        assembly_time_minutes: 0,
    ...
    methods: [
      {
        ...
        shortcut_level: 'scratch',
        ingredients: [
          { ingredient_id: 'broccoli', base_amount: 150, unit: 'g', scaling: 'flex', notes: 'Fresh or frozen mix of broccoli, carrots, cauliflower.' },
        ],
        instructions: [
          { summary: 'Steam the vegetables for 8-10 minutes until tender-crisp, then season lightly with salt.', substeps: ['Steam the vegetables for 8-10 minutes until tender-crisp, then season lightly with salt.'] },
        ],
      },
    ],
  },
  ...
  baked_potato: {
    ...
    min_scale: 0.5,
    max_scale: 2.0,
    flex_ingredient_id: 'baking_potato',
    contains_allergens: [],
    image_filename: 'baked_potato.png',
    photo_url: undefined,
    meal_prep: { strategy: 'none', reason: 'Bake fresh — best eaten hot from the oven.' },
    plates: [
      {
        id: 'standard',
        display_name: 'Baked Potato',
        description: 'A plain baked potato with skin — satisfying carbs with some fibre and potassium.',
        base_serving_multiplier: 1.0,
        additional_ingredients: [],
        additional_instructions: [],
        assembly_time_minutes: 0,
    ...
    methods: [
      {
        ...
        equipment_required: ['oven'],
        time_active_minutes: 2,
        time_total_minutes: 50,
        skill_min: 1,
        shortcut_level: 'scratch',
        ingredients: [
          { ingredient_id: 'baking_potato', base_amount: 150, unit: 'g', scaling: 'flex', notes: 'Medium potato, scrubbed clean.' },
        ],
        instructions: [
          { summary: 'Pierce the potato with a fork, bake at 200°C (400°F) for 45 minutes until tender.', substeps: ['Pierce the potato with a fork, bake at 200°C (400°F) for 45 minutes until tender.'] },
        ],
      },
    ],
  },
  ...
  berries: {
    ...
    min_scale: 0.5,
    max_scale: 2.0,
    flex_ingredient_id: 'mixed_berries',
    contains_allergens: [],
    image_filename: 'berries.png',
    photo_url: undefined,
    meal_prep: { strategy: 'none', reason: 'Fresh berries — rinse and eat immediately.' },
    plates: [
      {
        id: 'standard',
        display_name: 'Mixed Berries',
        description: 'A bowl of mixed berries — blueberries, strawberries, raspberries. High fibre, antioxidants, natural sweetness.',
        base_serving_multiplier: 1.0,
        additional_ingredients: [],
        additional_instructions: [],
        assembly_time_minutes: 0,
    ...
    methods: [
      {
        id: 'no_cook',
        display_name: 'Rinse & Go',
        time_active_minutes: 2,
        time_total_minutes: 2,
        skill_min: 1,
        shortcut_level: 'scratch',
        ingredients: [
          { ingredient_id: 'mixed_berries', base_amount: 150, unit: 'g', scaling: 'flex', notes: 'Fresh or frozen berries — blueberries, strawberries, raspberries.' },
        ],
        instructions: [
          { summary: 'Rinse fresh berries gently and eat, or thaw frozen berries for 10 minutes.', substeps: ['Rinse fresh berries gently and eat, or thaw frozen berries for 10 minutes.'] },
        ],
      },
    ],
  },
