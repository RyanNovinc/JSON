  ...
  const createSamplePlan = async () => {
    try {
      ...
      await addMealToDate(testDate, {
        ...
        ingredients: [{ id: 'oats', name: 'Oats', amount: 1, unit: 'cup', category: 'grains', estimatedCost: 0, isOptional: false }],
      ...
      await addMealToDate(testDate, {
        ...
        ingredients: [{ id: 'chicken', name: 'Chicken', amount: 6, unit: 'oz', category: 'protein', estimatedCost: 0, isOptional: false }],
      ...
      await addMealToDate(testDate, {
        ...
        ingredients: [{ id: 'salmon', name: 'Salmon', amount: 6, unit: 'oz', category: 'protein', estimatedCost: 0, isOptional: false }],
