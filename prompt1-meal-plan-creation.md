I'm using a nutrition planning app called JSON.fit and need help creating a personalized meal plan.
**QUICK CREATION INSTRUCTIONS:**
1. **STANDARD KNOWLEDGE** - Use your existing knowledge base for common foods and recipes
2. **ESTIMATED PRICING** - Use typical pricing patterns for Coles in Australia
**MEAL PLAN REQUIREMENTS:**
1. **BUDGET CONSTRAINT** - Moderate budget category
2. **MEAL PREP FOCUSED** - I like some meal prep but also some fresh cooking - batch cook 1-2 items but vary the rest
3. **INCLUDE DETAILED GROCERY LIST** - Organize by categories (Proteins, Dairy, Produce, etc.) with exact quantities, units, and estimated prices from Coles
...
- Daily fiber target: 42g (aim for 37–47g range)
- 4 meals per day
- Plan duration: 7 days
- Snacking style: Occasional snacker
- Goal: gain_weight at fast_gain rate
...
- Allergies: None
- Avoid foods: None
- Eating challenges: Struggle to eat enough, Prefer liquid meals, Need saucy foods
...
- Sleep schedule: 9:30 PM - 6:30 AM
...
- Available equipment: stovetop, oven, microwave, air_fryer
...
- Shop at: Coles
- Focus on ingredients commonly available at Australia supermarkets
- Budget level: Moderate Spending - Balanced approach to cost and quality, some flexibility for variety
- Budget guidance: Based on the budget level above, estimate a realistic weekly grocery cost range in local currency for Canberra, Australia and keep the plan within that range. State your estimate in the grocery list summary.
...
Please create a detailed 7-day meal plan that:
1. **STARTS on Monday 2 Mar** and uses actual calendar dates
...
- **Item name** - Specific product name (e.g., "Coles Lean Beef Mince" not just "beef")
